...
public class GUIReactorControl extends GuiInfoContainer {
    ...
    protected void keyTyped(char ch, int i) throws IOException {
        ...
        switch (ch) {
            case '0':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 0, 0));
                break;
            case '1':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 10, 0));
                break;
            case '2':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 20, 0));
                break;
            case '3':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 30, 0));
                break;
            case '4':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 40, 0));
                break;
            case '5':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 50, 0));
                break;
            case '6':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 60, 0));
                break;
            case '7':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 70, 0));
                break;
            case '8':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 80, 0));
                break;
            case '9':
                mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
                PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 90, 0));
                break;
        }
