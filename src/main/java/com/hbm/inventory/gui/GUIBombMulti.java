    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if (testNuke.return2type() == testNuke.return5type())
            switch (testNuke.return2type()) {
                case 1:
                    drawTexturedModalRect(guiLeft + 124, guiTop + 34, 176, 0, 18, 18);
                    break;
                case 2:
                    drawTexturedModalRect(guiLeft + 124, guiTop + 34, 176, 18, 18, 18);
                    break;
                case 3:
                    drawTexturedModalRect(guiLeft + 124, guiTop + 34, 176, 2 * 18, 18, 18);
                    break;
                case 4:
                    drawTexturedModalRect(guiLeft + 124, guiTop + 34, 176, 3 * 18, 18, 18);
                    break;
                case 5:
                    drawTexturedModalRect(guiLeft + 124, guiTop + 34, 176, 4 * 18, 18, 18);
                    break;
                case 6:
                    drawTexturedModalRect(guiLeft + 124, guiTop + 34, 176, 5 * 18, 18, 18);
                    break;
            }
