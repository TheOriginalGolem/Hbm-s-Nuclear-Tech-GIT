    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        for (int i = 0; i < 4; i++) {
            if (testNuke.inventory.getStackInSlot(i) != null && testNuke.inventory.getStackInSlot(i).getItem() == ModItems.man_explosive8)
                switch (i) {
                    case 0:
                        drawTexturedModalRect(guiLeft + 24, guiTop + 20, 209, 1, 23, 23);
                        break;
                    case 2:
                        drawTexturedModalRect(guiLeft + 47, guiTop + 20, 232, 1, 23, 23);
                        break;
                    case 1:
                        drawTexturedModalRect(guiLeft + 24, guiTop + 43, 209, 24, 23, 23);
                        break;
                    case 3:
                        drawTexturedModalRect(guiLeft + 47, guiTop + 43, 232, 24, 23, 23);
                        break;
                }
        }
    }
