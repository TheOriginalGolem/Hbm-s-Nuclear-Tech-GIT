...
public class EntityFBI extends EntityMob implements IRangedAttackMob {
    ...
    protected void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty) {
        ...
        switch (equip) {
            case 0:
                this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ModItems.gun_revolver_nopip));
                break;
            case 1:
                this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ModItems.gun_ks23));
                break;
        }
        if (rand.nextInt(5) == 0) {
