...
public class CraftingManager {
	...
	public static void addCrafting(){
		...
		addShapedRecipe(new ItemStack(ModItems.redstone_sword, 1), "R", "R", "S", 'R', Blocks.REDSTONE_BLOCK, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.big_sword, 1), "QIQ", "QIQ", "GSG", 'G', Items.GOLD_INGOT, 'S', Items.STICK, 'I', Items.IRON_INGOT, 'Q', Items.QUARTZ);
		...
		addShapedOreRecipe(new ItemStack(ModItems.hazmat_cloth_grey, 1), " P ", "ICI", " L ", 'C', ModItems.hazmat_cloth_red, 'P', IRON.plate(), 'L', "plateLead", 'I', ModItems.plate_polymer);
		addShapedOreRecipe(new ItemStack(ModItems.asbestos_cloth, 8), "SCS", "CPC", "SCS", 'S', Items.STRING, 'P', ModItems.powder_bromine, 'C', Blocks.WOOL);
		...
		addShapedOreRecipe(new ItemStack(ModItems.bolt_tungsten, 4), "D", "D", 'D', W.ingot());
		...
		addShapedOreRecipe(new ItemStack(ModItems.pellet_coal, 1), "PFP", "FOF", "PFP", 'P', "dustCoal", 'F', Items.FLINT, 'O', ModBlocks.gravel_obsidian);
		addShapedRecipe(new ItemStack(ModItems.plate_polymer, 8), "DD", 'D', ModItems.ingot_polymer);
		addShapedRecipe(new ItemStack(ModItems.plate_polymer, 4), "SWS", 'S', Items.STRING, 'W', Blocks.WOOL);
		addShapedRecipe(new ItemStack(ModItems.plate_polymer, 4), "BB", 'B', Items.BRICK);

		addShapedOreRecipe(new ItemStack(ModBlocks.marker_structure, 1), "L", "G", "R", 'L', "dustLapis", 'G', Items.GLOWSTONE_DUST, 'R', Blocks.REDSTONE_TORCH);
		...
		addShapelessRecipe(new ItemStack(ModItems.bio_wafer, 1), ModItems.biomass_compressed, ModItems.biomass_compressed);

		addShapelessOreRecipe(new ItemStack(Items.GUNPOWDER, 3), "dustSulfur", "dustSaltpeter", Items.COAL);
		addShapelessOreRecipe(new ItemStack(Items.GUNPOWDER, 3), "dustSulfur", "dustSaltpeter", new ItemStack(Items.COAL, 1, 1));

		addShapedOreRecipe(new ItemStack(ModItems.cell, 6), "SSS", "G G", "SSS", 'S', "plateSteel", 'G', "paneGlass");
		addShapedRecipe(ItemCell.getFullCell(ModForgeFluids.deuterium, 8), "DDD", "DTD", "DDD", 'D',new IngredientNBT2( new ItemStack (ModItems.cell)), 'T', ModItems.mike_deut);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.vitrified_barrel, 1), "LSL", "PWP", "LSL", 'L', "plateLead", 'S', Blocks.SAND, 'P', "ingotPolymer", 'W', ModBlocks.block_waste);
		addShapelessOreRecipe(new ItemStack(ModBlocks.block_waste_painted, 1), "dyeYellow", ModBlocks.block_waste);

		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_aluminium), 1), "###", "###", "###", '#', ModItems.ingot_aluminium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_copper), 1), "###", "###", "###", '#', ModItems.ingot_copper);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_fluorite), 1), "###", "###", "###", '#', ModItems.fluorite);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_niter), 1), "###", "###", "###", '#', ModItems.niter);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_red_copper), 1), "###", "###", "###", '#', ModItems.ingot_red_copper);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_steel), 1), "###", "###", "###", '#', ModItems.ingot_steel);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_sulfur), 1), "###", "###", "###", '#', ModItems.sulfur);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_titanium), 1), "###", "###", "###", '#', ModItems.ingot_titanium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_tungsten), 1), "###", "###", "###", '#', ModItems.ingot_tungsten);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_uranium), 1), "###", "###", "###", '#', ModItems.ingot_uranium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_thorium), 1), "###", "###", "###", '#', ModItems.ingot_th232);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_lead), 1), "###", "###", "###", '#', ModItems.ingot_lead);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_trinitite), 1), "###", "###", "###", '#', ModItems.trinitite);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_waste), 1), "###", "###", "###", '#', ModItems.nuclear_waste);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_scrap), 1), "##", "##", '#', ModItems.scrap);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_scrap), 1), "###", "###", "###", '#', ModItems.dust);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_beryllium), 1), "###", "###", "###", '#', ModItems.ingot_beryllium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_schrabidium), 1), "###", "###", "###", '#', ModItems.ingot_schrabidium);
		...
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_euphemium), 1), "###", "###", "###", '#', ModItems.ingot_euphemium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_advanced_alloy), 1), "###", "###", "###", '#', ModItems.ingot_advanced_alloy);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_magnetized_tungsten), 1), "###", "###", "###", '#', ModItems.ingot_magnetized_tungsten);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_combine_steel), 1), "###", "###", "###", '#', ModItems.ingot_combine_steel);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_australium), 1), "###", "###", "###", '#', ModItems.ingot_australium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_weidanium), 1), "###", "###", "###", '#', ModItems.ingot_weidanium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_reiium), 1), "###", "###", "###", '#', ModItems.ingot_reiium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_unobtainium), 1), "###", "###", "###", '#', ModItems.ingot_unobtainium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_daffergon), 1), "###", "###", "###", '#', ModItems.ingot_daffergon);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_verticium), 1), "###", "###", "###", '#', ModItems.ingot_verticium);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_desh), 1), "###", "###", "###", '#', ModItems.ingot_desh);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_dura_steel), 1), "###", "###", "###", '#', ModItems.ingot_dura_steel);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_saturnite), 1), "###", "###", "###", '#', ModItems.ingot_saturnite);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_ra226), 1), "###", "###", "###", '#', ModItems.ingot_ra226);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_polymer), 1), "###", "###", "###", '#', ModItems.ingot_polymer);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_meteor_cobble), 1), "##", "##", '#', ModItems.fragment_meteorite);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_meteor_broken), 1), "###", "###", "###", '#', ModItems.fragment_meteorite);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_yellowcake), 1), "###", "###", "###", '#', ModItems.powder_yellowcake);
		addShapedRecipe(new ItemStack(ModBlocks.block_starmetal, 1), "###", "###", "###", '#', ModItems.ingot_starmetal);
		addShapedRecipe(new ItemStack(ModBlocks.block_niter_reinforced, 1), "TCT", "CNC", "TCT", 'T', ModItems.ingot_tcalloy, 'C', ModBlocks.concrete, 'N', ModBlocks.block_niter);
		...
		addShapedRecipe(new ItemStack(ModItems.ingot_copper, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_copper));
		addShapedRecipe(new ItemStack(ModItems.fluorite, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_fluorite));
		addShapedRecipe(new ItemStack(ModItems.niter, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_niter));
		addShapedRecipe(new ItemStack(ModItems.ingot_red_copper, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_red_copper));
		addShapedRecipe(new ItemStack(ModItems.ingot_steel, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_steel));
		addShapedRecipe(new ItemStack(ModItems.sulfur, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_sulfur));
		addShapedRecipe(new ItemStack(ModItems.ingot_titanium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_titanium));
		addShapedRecipe(new ItemStack(ModItems.ingot_tungsten, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_tungsten));
		addShapedRecipe(new ItemStack(ModItems.ingot_uranium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_uranium));
		addShapedRecipe(new ItemStack(ModItems.ingot_th232, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_thorium));
		addShapedRecipe(new ItemStack(ModItems.ingot_lead, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_lead));
		addShapedRecipe(new ItemStack(ModItems.trinitite, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_trinitite));
		addShapedRecipe(new ItemStack(ModItems.nuclear_waste, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_waste));
		addShapedRecipe(new ItemStack(ModItems.nuclear_waste, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_waste_painted));
		addShapedRecipe(new ItemStack(ModItems.ingot_beryllium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_beryllium));
		addShapedRecipe(new ItemStack(ModItems.ingot_schrabidium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_schrabidium));
		addShapedRecipe(new ItemStack(ModItems.ingot_euphemium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_euphemium));
		addShapedRecipe(new ItemStack(ModItems.ingot_advanced_alloy, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_advanced_alloy));
		addShapedRecipe(new ItemStack(ModItems.ingot_magnetized_tungsten, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_magnetized_tungsten));
		addShapedRecipe(new ItemStack(ModItems.ingot_combine_steel, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_combine_steel));
		addShapedRecipe(new ItemStack(ModItems.ingot_australium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_australium));
		addShapedRecipe(new ItemStack(ModItems.ingot_weidanium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_weidanium));
		addShapedRecipe(new ItemStack(ModItems.ingot_reiium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_reiium));
		addShapedRecipe(new ItemStack(ModItems.ingot_unobtainium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_unobtainium));
		addShapedRecipe(new ItemStack(ModItems.ingot_daffergon, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_daffergon));
		addShapedRecipe(new ItemStack(ModItems.ingot_verticium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_verticium));
		addShapedRecipe(new ItemStack(ModItems.ingot_desh, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_desh));
		addShapedRecipe(new ItemStack(ModItems.ingot_dura_steel, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_dura_steel));
		addShapedRecipe(new ItemStack(ModItems.ingot_saturnite, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_saturnite));
		addShapedRecipe(new ItemStack(ModItems.ingot_ra226, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_ra226));
		addShapedRecipe(new ItemStack(ModItems.ingot_polymer, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_polymer));
		addShapedRecipe(new ItemStack(ModItems.powder_yellowcake, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_yellowcake));
		...
		addShapedRecipe(new ItemStack(ModItems.ingot_ac227, 1), "###", "###", "###", '#', ModItems.nugget_ac227);
		addShapedRecipe(new ItemStack(ModItems.nugget_ac227, 9), "#", '#', ModItems.ingot_ac227);
		addShapedRecipe(new ItemStack(ModItems.ingot_actinium, 1), "###", "###", "###", '#', ModItems.nugget_actinium);
		addShapedRecipe(new ItemStack(ModItems.nugget_actinium, 9), "#", '#', ModItems.ingot_actinium);
		addShapedRecipe(new ItemStack(ModItems.ingot_cobalt, 1), "###", "###", "###", '#', ModItems.nugget_cobalt);
		addShapedRecipe(new ItemStack(ModItems.nugget_cobalt, 9), "#", '#', ModItems.ingot_cobalt);
		addShapedRecipe(new ItemStack(ModItems.ingot_sr90, 1), "###", "###", "###", '#', ModItems.nugget_sr90);
		addShapedRecipe(new ItemStack(ModItems.nugget_sr90, 9), "#", '#', ModItems.ingot_sr90);
		addShapedRecipe(new ItemStack(ModItems.ingot_strontium, 1), "###", "###", "###", '#', ModItems.nugget_strontium);
		addShapedRecipe(new ItemStack(ModItems.nugget_strontium, 9), "#", '#', ModItems.ingot_strontium);
		addShapedRecipe(new ItemStack(ModItems.ingot_pb209, 1), "###", "###", "###", '#', ModItems.nugget_pb209);
		addShapedRecipe(new ItemStack(ModItems.nugget_pb209, 9), "#", '#', ModItems.ingot_pb209);
		addShapedRecipe(new ItemStack(ModItems.ingot_gh336, 1), "###", "###", "###", '#', ModItems.nugget_gh336);
		addShapedRecipe(new ItemStack(ModItems.nugget_gh336, 9), "#", '#', ModItems.ingot_gh336);
		addShapedRecipe(new ItemStack(ModItems.ingot_u238m2, 1), "###", "###", "###", '#', ModItems.nugget_u238m2);
		addShapedRecipe(new ItemStack(ModItems.nugget_u238m2, 9), "#", '#', ModItems.ingot_u238m2);
		addShapedRecipe(new ItemStack(ModItems.ingot_ra226, 1), "###", "###", "###", '#', ModItems.nugget_ra226);
		addShapedRecipe(new ItemStack(ModItems.nugget_ra226, 9), "#", '#', ModItems.ingot_ra226);

		addShapedRecipe(new ItemStack(ModItems.powder_radspice, 1), "ABC", "DEF", "HIJ", 'A', ModItems.powder_co60, 'B', ModItems.powder_sr90, 'C', ModItems.powder_i131, 'D', ModItems.powder_cs137, 'E', ModItems.powder_xe135, 'F', ModItems.powder_au198, 'H', ModItems.powder_pb209, 'I', ModItems.powder_at209, 'J', ModItems.powder_ac227);
		...
		addShapelessRecipe(new ItemStack(ModItems.rod_ac227, 1), ModItems.rod_empty, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227);
		addShapelessRecipe(new ItemStack(ModItems.rod_cobalt, 1), ModItems.rod_empty, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt);
		addShapelessRecipe(new ItemStack(ModItems.rod_co60, 1), ModItems.rod_empty, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60);
		addShapelessRecipe(new ItemStack(ModItems.rod_ra226, 1), ModItems.rod_empty, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226);
		addShapelessRecipe(new ItemStack(ModItems.rod_rgp, 1), ModItems.rod_empty, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix);
		...
		addShapelessRecipe(new ItemStack(ModItems.rod_dual_ac227, 1), ModItems.rod_dual_empty, ModItems.ingot_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227);
		addShapelessRecipe(new ItemStack(ModItems.rod_dual_cobalt, 1), ModItems.rod_dual_empty, ModItems.ingot_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt);
		addShapelessRecipe(new ItemStack(ModItems.rod_dual_co60, 1), ModItems.rod_dual_empty, ModItems.ingot_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60);
		addShapelessRecipe(new ItemStack(ModItems.rod_dual_ra226, 1), ModItems.rod_dual_empty, ModItems.ingot_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226);
		addShapelessRecipe(new ItemStack(ModItems.rod_dual_rgp, 1), ModItems.rod_dual_empty, ModItems.ingot_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix);
		...
		addShapelessRecipe(ItemCell.getFullCell(ModForgeFluids.tritium, 2), ModItems.rod_dual_tritium,new IngredientNBT2( new ItemStack (ModItems.cell)),new IngredientNBT2( new ItemStack (ModItems.cell)));
		addShapelessRecipe(ItemCell.getFullCell(ModForgeFluids.tritium, 4), ModItems.rod_quad_tritium, new IngredientNBT2( new ItemStack (ModItems.cell)),new IngredientNBT2( new ItemStack (ModItems.cell)),new IngredientNBT2( new ItemStack (ModItems.cell)),new IngredientNBT2( new ItemStack (ModItems.cell)));
		...
		addShapelessRecipe(new ItemStack(ModItems.rod_quad_ac227, 1), ModItems.rod_quad_empty, ModItems.ingot_ac227, ModItems.ingot_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227, ModItems.nugget_ac227);
		addShapelessRecipe(new ItemStack(ModItems.rod_quad_cobalt, 1), ModItems.rod_quad_empty, ModItems.ingot_cobalt, ModItems.ingot_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt, ModItems.nugget_cobalt);
		addShapelessRecipe(new ItemStack(ModItems.rod_quad_co60, 1), ModItems.rod_quad_empty, ModItems.ingot_co60, ModItems.ingot_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60, ModItems.nugget_co60);
		addShapelessRecipe(new ItemStack(ModItems.rod_quad_ra226, 1), ModItems.rod_quad_empty, ModItems.ingot_ra226, ModItems.ingot_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226, ModItems.nugget_ra226);
		addShapelessRecipe(new ItemStack(ModItems.rod_quad_rgp, 1), ModItems.rod_quad_empty, ModItems.ingot_pu_mix, ModItems.ingot_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix, ModItems.nugget_pu_mix);
		...
		addShapelessRecipe(new ItemStack(ModItems.billet_zfb_bismuth), ModItems.nugget_zirconium, ModItems.nugget_zirconium, ModItems.nugget_zirconium, ModItems.nugget_uranium, ModItems.nugget_pu241, ModItems.nugget_bismuth);
		addShapelessRecipe(new ItemStack(ModItems.billet_zfb_pu241), ModItems.nugget_zirconium, ModItems.nugget_zirconium, ModItems.nugget_zirconium, ModItems.nugget_u235, ModItems.nugget_pu240, ModItems.nugget_pu241);
		addShapelessRecipe(new ItemStack(ModItems.billet_zfb_am_mix), ModItems.nugget_zirconium, ModItems.nugget_zirconium, ModItems.nugget_zirconium, ModItems.nugget_pu241, ModItems.nugget_pu241, ModItems.nugget_am_mix);

		addShapelessRecipe(new ItemStack(ModItems.billet_zfb_bismuth, 6), ModItems.billet_zirconium, ModItems.billet_zirconium, ModItems.billet_zirconium, ModItems.billet_uranium, ModItems.billet_pu241, ModItems.billet_bismuth);
		addShapelessRecipe(new ItemStack(ModItems.billet_zfb_pu241, 6), ModItems.billet_zirconium, ModItems.billet_zirconium, ModItems.billet_zirconium, ModItems.billet_u235, ModItems.billet_pu240, ModItems.billet_pu241);
		addShapelessRecipe(new ItemStack(ModItems.billet_zfb_am_mix, 6), ModItems.billet_zirconium, ModItems.billet_zirconium, ModItems.billet_zirconium, ModItems.billet_pu241, ModItems.billet_pu241, ModItems.billet_am_mix);

		addShapelessRecipe(new ItemStack(ModItems.billet_unobtainium, 4), ModBlocks.block_unobtainium, ModBlocks.block_unobtainium, ModBlocks.block_unobtainium, ModItems.ingot_radspice, ModItems.ingot_dineutronium, ModItems.ingot_am241);

		addShapelessRecipe(new ItemStack(ModItems.rod_water, 1), ModItems.rod_empty, Items.WATER_BUCKET);
		addShapelessRecipe(new ItemStack(ModItems.rod_dual_water, 1), ModItems.rod_dual_empty, Items.WATER_BUCKET, Items.WATER_BUCKET);
		addShapelessRecipe(new ItemStack(ModItems.rod_quad_water, 1), ModItems.rod_quad_empty, Items.WATER_BUCKET, Items.WATER_BUCKET, Items.WATER_BUCKET, Items.WATER_BUCKET);
		...
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.MELON, Items.MELON, Items.MELON, Items.MELON, Items.MELON, Items.MELON, Items.MELON);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.APPLE, Items.APPLE, Items.APPLE, Items.APPLE, Items.APPLE, Items.APPLE, Items.APPLE, Items.APPLE, Items.APPLE);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.REEDS, Items.REEDS, Items.REEDS, Items.REEDS, Items.REEDS, Items.REEDS, Items.REEDS, Items.REEDS, Items.REEDS);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.ROTTEN_FLESH, Items.ROTTEN_FLESH, Items.ROTTEN_FLESH, Items.ROTTEN_FLESH, Items.ROTTEN_FLESH, Items.ROTTEN_FLESH, Items.ROTTEN_FLESH);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.CARROT, Items.CARROT, Items.CARROT, Items.CARROT, Items.CARROT, Items.CARROT, Items.CARROT, Items.CARROT, Items.CARROT);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO, Items.POISONOUS_POTATO);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 4), Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO, Items.POTATO);
		...
		addShapelessRecipe(new ItemStack(ModItems.biomass, 8), Blocks.PUMPKIN, Blocks.PUMPKIN, Blocks.PUMPKIN, Blocks.PUMPKIN, Blocks.PUMPKIN, Blocks.PUMPKIN);
		...
		addShapelessRecipe(new ItemStack(ModItems.biomass, 8), Blocks.HAY_BLOCK, Blocks.HAY_BLOCK);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 1), Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 2), Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS);
		addShapelessRecipe(new ItemStack(ModItems.biomass, 2), Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS);

		addShapelessOreRecipe(new ItemStack(ModBlocks.deco_aluminium), AL.ingot(), ModBlocks.steel_scaffold);
		...
		addShapelessOreRecipe(new ItemStack(ModBlocks.deco_tungsten), W.ingot(), ModBlocks.steel_scaffold);
		...
		addShapedOreRecipe(new ItemStack(ModItems.coil_copper_torus, 2), " C ", "CPC", " C ", 'P', IRON.plate(), 'C', ModItems.coil_copper);
		addShapedOreRecipe(new ItemStack(ModItems.coil_advanced_torus, 2), " C ", "CPC", " C ", 'P', IRON.plate(), 'C', ModItems.coil_advanced_alloy);
		addShapedOreRecipe(new ItemStack(ModItems.coil_gold_torus, 2), " C ", "CPC", " C ", 'P', IRON.plate(), 'C', ModItems.coil_gold);
		...
		addShapedOreRecipe(new ItemStack(ModItems.motor, 2), " R ", "ICI", "ITI", 'R', ModItems.wire_red_copper, 'T', ModItems.coil_copper_torus, 'I', IRON.plate(), 'C', ModItems.coil_copper);
		...
		addShapedOreRecipe(new ItemStack(ModItems.motor_desh, 1), "PCP", "DMD", "PCP", 'P', ModItems.ingot_polymer, 'C', ModItems.coil_gold_torus, 'D', DESH.ingot(), 'M', ModItems.motor);
		addShapedRecipe(new ItemStack(ModItems.thermo_unit_endo, 1), "EEE", "ETE", "EEE", 'E', Item.getItemFromBlock(Blocks.ICE), 'T', ModItems.thermo_unit_empty);
		addShapedRecipe(new ItemStack(ModItems.thermo_unit_exo, 1), "LLL", "LTL", "LLL", 'L', Items.LAVA_BUCKET, 'T', ModItems.thermo_unit_empty);

		addShapedOreRecipe(new ItemStack(ModItems.cap_aluminium, 1), "PIP", 'P', "plateAluminum", 'I', AL.ingot());
		...
		addShapedOreRecipe(new ItemStack(ModItems.hull_big_aluminium, 1), "III", "   ", "III", 'I', AL.ingot());
		...
		addShapedOreRecipe(new ItemStack(ModItems.lemon, 1), " D ", "DSD", " D ", 'D', new ItemStack(Items.DYE, 1, 11), 'S', "stone");
		...
		addShapedOreRecipe(new ItemStack(ModItems.shimmer_axe_head, 1), "PII", "PBB", "PII", 'P', "plateSteel", 'B', "blockDesh", 'I', W.ingot());
		...
		addShapedOreRecipe(new ItemStack(ModItems.definitelyfood, 1), "DDD", "SDS", "DDD", 'D', Blocks.DIRT, 'S', "plateSteel");
		addShapedOreRecipe(new ItemStack(ModItems.blade_tungsten, 2), "IP", "TP", "TI", 'P', "plateTitanium", 'T', "ingotTitanium", 'I', W.ingot());
		...
		addShapedRecipe(new ItemStack(ModItems.wrench_flipped, 1), "S", "D", "W", 'S', Items.IRON_SWORD, 'D', ModItems.ducttape, 'W', ModItems.wrench);
		...
		addShapelessRecipe(new ItemStack(ModItems.toothpicks, 3), Items.STICK, Items.STICK, Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.ducttape, 6), "FSF", "SPS", "FSF", 'F', Items.STRING, 'S', Items.SLIME_BALL, 'P', Items.PAPER);
		...
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.machine_difurnace_off), 1), "T T", "PHP", "TFT", 'T', W.ingot(), 'P', ModItems.board_copper, 'H', Blocks.HOPPER, 'F', Blocks.FURNACE);
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.machine_uf6_tank), 1), "WTW", "WTW", "SRS", 'S', IRON.plate(), 'W', ModItems.coil_tungsten, 'T', ModItems.tank_steel, 'W', ModItems.coil_tungsten, 'R', "ingotMingrade");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.machine_puf6_tank), 1), "WTW", "WTW", "SRS", 'S', "plateSteel", 'W', ModItems.coil_tungsten, 'T', ModItems.tank_steel, 'W', ModItems.coil_tungsten, 'R', "ingotMingrade");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.machine_nuke_furnace_off), 1), "SSS", "LFL", "CCC", 'S', "plateSteel", 'C', ModItems.board_copper, 'L', "plateLead", 'F', Item.getItemFromBlock(Blocks.FURNACE));
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.machine_electric_furnace_off), 1), "BBB", "WFW", "RRR", 'B', ModItems.ingot_beryllium, 'R', ModItems.coil_tungsten, 'W', ModItems.board_copper, 'F', Item.getItemFromBlock(Blocks.FURNACE));
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_arc_furnace_off, 1), "ITI", "PFP", "ITI", 'I', W.ingot(), 'T', ModBlocks.machine_transformer, 'P', ModItems.board_copper, 'F', Blocks.FURNACE);
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.red_wire_coated), 16), "WRW", "RIR", "WRW", 'W', ModItems.plate_polymer, 'I', "ingotMingrade", 'R', ModItems.wire_red_copper);
		addShapedRecipe(new ItemStack(ModBlocks.cable_switch, 1), "S", "W", 'S', Blocks.LEVER, 'W', ModBlocks.red_wire_coated);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.red_cable), 16), " W ", "RRR", " W ", 'W', ModItems.plate_polymer, 'R', ModItems.wire_red_copper);
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.red_pylon), 4), "CWC", "PWP", " T ", 'C', ModItems.coil_copper_torus, 'W', "plankWood", 'P', ModItems.plate_polymer, 'T', ModBlocks.red_wire_coated);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_battery_potato, 1), "PCP", "WRW", "PCP", 'P', ItemBattery.getEmptyBattery(ModItems.battery_potato), 'C', CU.ingot(), 'R', Blocks.REDSTONE_BLOCK, 'W', "plankWood");
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_coal_off, 1), "STS", "SCS", "SFS", 'S', "ingotSteel", 'T', ModItems.tank_steel, 'C', "ingotMingrade", 'F', Blocks.FURNACE);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_boiler_off, 1), "SPS", "TFT", "SPS", 'S', "ingotSteel", 'P', ModItems.board_copper, 'T', ModItems.tank_steel, 'F', Blocks.FURNACE);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_boiler_electric_off, 1), "SPS", "TFT", "SPS", 'S', DESH.ingot(), 'P', ModItems.board_copper, 'T', ModItems.tank_steel, 'F', ModBlocks.machine_electric_furnace_off);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_boiler_rtg_off, 1), "SPS", "TFT", "SPS", 'S', "ingotStarmetal", 'P', ModItems.board_copper, 'T', ModItems.tank_steel, 'F', ModBlocks.machine_rtg_furnace_off);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.crate_iron, 1), "PPP", "I I", "III", 'P', IRON.plate(), 'I', "ingotIron");
		addShapedOreRecipe(new ItemStack(ModBlocks.crate_steel, 1), "PPP", "I I", "III", 'P', "plateSteel", 'I', "ingotSteel");
		addShapedRecipe(new ItemStack(ModBlocks.crate_desh, 1), " P ", "PAP", " P ", 'P', ModItems.plate_desh, 'A', ModBlocks.crate_steel);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.safe, 1), "LAL", "ACA", "LAL", 'L', "plateLead", 'A', ALLOY.plate(), 'C', ModBlocks.crate_steel);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_waste_drum, 1), "LRL", "BRB", "LRL", 'L', "ingotLead", 'B', Blocks.IRON_BARS, 'R', ModItems.rod_quad_empty);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_press, 1), "IRI", "IPI", "IBI", 'I', "ingotIron", 'R', Blocks.FURNACE, 'B', "blockIron", 'P', Blocks.PISTON);
		...
		addShapedRecipe(new ItemStack(ModBlocks.muffler, 1), "III", "IWI", "III", 'I', ModItems.plate_polymer, 'W', Blocks.WOOL);

		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.factory_titanium_hull), 1), "PIP", "I I", "PIP", 'P', "plateTitanium", 'I', "ingotTitanium");
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.factory_titanium_furnace), 1), "HMH", "MFM", "HMH", 'H', Item.getItemFromBlock(ModBlocks.factory_titanium_hull), 'M', ModItems.motor, 'F', Item.getItemFromBlock(Blocks.FURNACE));
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.factory_titanium_conductor), 1), "SWS", "FFF", "SWS", 'S', "ingotTitanium", 'W', Item.getItemFromBlock(ModBlocks.red_wire_coated), 'F', ModItems.fuse);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.factory_titanium_core), 1), "HPH", "PCP", "HPH", 'H', Item.getItemFromBlock(ModBlocks.factory_titanium_hull), 'C', ModItems.circuit_aluminium, 'P', Item.getItemFromBlock(Blocks.PISTON));
		addShapedRecipe(ItemBattery.getEmptyBattery(ModItems.factory_core_titanium), "BRB", "RHR", "BRB", 'B', ItemBattery.getEmptyBattery(ModItems.battery_generic), 'R', Item.getItemFromBlock(Blocks.REDSTONE_BLOCK), 'H', Item.getItemFromBlock(ModBlocks.factory_titanium_hull));
		addShapedOreRecipe(ItemBattery.getEmptyBattery(ModItems.factory_core_advanced), "BLB", "SHS", "BLB", 'B', ItemBattery.getEmptyBattery(ModItems.battery_advanced), 'S', "blockSulfur", 'L', "blockLead", 'H', Item.getItemFromBlock(ModBlocks.factory_advanced_hull));
		addShapedOreRecipe(ItemBattery.getEmptyBattery(ModItems.factory_core_advanced), "BSB", "LHL", "BSB", 'B', ItemBattery.getEmptyBattery(ModItems.battery_advanced), 'S', "blockSulfur", 'L', "blockLead", 'H', Item.getItemFromBlock(ModBlocks.factory_advanced_hull));

		addShapedOreRecipe(new ItemStack(ModItems.arc_electrode, 1), "C", "T", "C", 'C', "dustCoal", 'T', ModItems.bolt_tungsten);
		addShapedOreRecipe(new ItemStack(ModItems.arc_electrode_desh, 1), "C", "T", "C", 'C', DESH.dust(), 'T', ModItems.arc_electrode);
		...
		addShapedOreRecipe(new ItemStack(ModItems.detonator_laser, 1), "RRD", "PIC", "  P", 'P', "plateSteel", 'R', Items.REDSTONE, 'C', ModItems.circuit_targeting_tier3, 'D', "gemDiamond", 'I', "ingotSteel");
		addShapedOreRecipe(new ItemStack(ModItems.detonator_laser, 1), "RRD", "PIC", "  P", 'P', "plateSteel", 'R', Items.REDSTONE, 'C', ModItems.circuit_targeting_tier3, 'D', "gemEmerald", 'I', "ingotSteel");
		addShapelessRecipe(new ItemStack(ModItems.detonator_deadman, 1), ModItems.detonator, ModItems.defuser, ModItems.ducttape);
		addShapedRecipe(new ItemStack(ModItems.detonator_de, 1), "T", "D", "T", 'T', Blocks.TNT, 'D', ModItems.detonator_deadman);

		addShapedRecipe(ItemBombCaller.getStack(EnumCallerType.CARPET), "TTT", "TRT", "TTT", 'T', Blocks.TNT, 'R', ModItems.detonator_laser);
		addShapedRecipe(ItemBombCaller.getStack(EnumCallerType.NAPALM), "TTT", "TRT", "TTT", 'T', ModItems.grenade_gascan, 'R', ModItems.detonator_laser);
		addShapedRecipe(ItemBombCaller.getStack(EnumCallerType.POISON), "TTT", "TRT", "TTT", 'T', ModItems.pellet_gas, 'R', ModItems.detonator_laser);
		addShapedRecipe(ItemBombCaller.getStack(EnumCallerType.ORANGE), "TRT", 'T', ModItems.grenade_cloud, 'R', ModItems.detonator_laser);
		addShapedRecipe(ItemBombCaller.getStack(EnumCallerType.ATOMIC), "TRT", 'T', ModItems.gun_fatman_ammo, 'R', ModItems.detonator_laser);

		addShapedRecipe(new ItemStack(ModItems.singularity, 1), "ESE", "SBS", "ESE", 'E', ModItems.nugget_euphemium, 'S', new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.aschrab)), 'B', Item.getItemFromBlock(ModBlocks.block_schrabidium));
		...
		addShapedRecipe(new ItemStack(ModItems.crystal_energy, 1), "EEE", "EGE", "EEE", 'E', ModItems.powder_power, 'G', Items.GLOWSTONE_DUST);
		...
		addShapedOreRecipe(new ItemStack(ModItems.blades_aluminum, 1), " P ", "PIP", " P ", 'P', "plateAluminum", 'I', AL.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.blades_gold, 1), " P ", "PIP", " P ", 'P', "plateGold", 'I', "ingotGold");
		addShapedOreRecipe(new ItemStack(ModItems.blades_iron, 1), " P ", "PIP", " P ", 'P', IRON.plate(), 'I', "ingotIron");
		...
		addShapedOreRecipe(new ItemStack(ModItems.blades_advanced_alloy, 1), " P ", "PIP", " P ", 'P', ALLOY.plate(), 'I', "ingotAdvanced");
		...
		addShapedOreRecipe(new ItemStack(ModItems.blades_aluminum, 1), "PIP", 'P', "plateAluminum", 'I', new ItemStack(ModItems.blades_aluminum, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_gold, 1), "PIP", 'P', "plateGold", 'I', new ItemStack(ModItems.blades_gold, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_iron, 1), "PIP", 'P', IRON.plate(), 'I', new ItemStack(ModItems.blades_iron, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_steel, 1), "PIP", 'P', "plateSteel", 'I', new ItemStack(ModItems.blades_steel, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_titanium, 1), "PIP", 'P', "plateTitanium", 'I', new ItemStack(ModItems.blades_titanium, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_advanced_alloy, 1), "PIP", 'P', ALLOY.plate(), 'I', new ItemStack(ModItems.blades_advanced_alloy, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_combine_steel, 1), "PIP", 'P', "plateCMBSteel", 'I', new ItemStack(ModItems.blades_combine_steel, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.blades_schrabidium, 1), "PIP", 'P', "plateSchrabidium", 'I', new ItemStack(ModItems.blades_schrabidium, 1, OreDictionary.WILDCARD_VALUE));

		addShapedRecipe(new ItemStack(ModItems.laser_crystal_nano, 1), "QPQ", "ACA", "QPQ", 'Q', ModBlocks.glass_quartz, 'P', ModItems.ingot_graphite, 'A', ModItems.powder_polymer, 'C', ModItems.filter_coal);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_pentacene, 1), "QSQ", "AEA", "QSQ", 'Q', ModBlocks.glass_quartz, 'A', ModItems.powder_advanced_alloy, 'S', ModItems.ingot_cerium, 'E', ModItems.crystal_energy);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_co2, 1), "QDQ", "NCN", "QDQ", 'Q', ModBlocks.glass_quartz, 'D', ModItems.ingot_desh, 'N', ModItems.ingot_niobium, 'C', ModItems.part_carbon);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_bismuth, 1), "QUQ", "BCB", "QTQ", 'Q', ModBlocks.glass_quartz, 'U', ModItems.ingot_uranium, 'T', ModItems.ingot_th232, 'B', ModItems.nugget_bismuth, 'C', ModItems.crystal_rare);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_cmb, 1), "QBQ", "CSC", "QBQ", 'Q', ModBlocks.glass_quartz, 'B', ModItems.ingot_combine_steel, 'C', ModItems.nugget_daffergon, 'S', ModItems.powder_xe135);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_dem, 1), "QAQ", "SBS", "QDQ", 'Q', ModBlocks.glass_quartz, 'D', ModItems.ingot_schrabidate, 'B', ModItems.demon_core_open, 'S', ModItems.powder_tennessine, 'A', ModItems.ingot_tantalium);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_bale, 1), "QDQ", "SBS", "QDQ", 'Q', ModBlocks.glass_quartz, 'D', ModItems.plate_dineutronium, 'B', ModItems.rbmk_pellet_balefire, 'S', ModItems.powder_radspice);
		addShapedRecipe(new ItemStack(ModItems.laser_crystal_digamma, 1), "QUQ", "UEU", "QUQ", 'Q', ModBlocks.glass_quartz, 'U', ModItems.undefined, 'E', ModItems.ingot_electronium);
		...
		addShapedOreRecipe(new ItemStack(ModItems.stamp_obsidian_flat, 1), " R ", "III", "SSS", 'R', "dustRedstone", 'I', "ingotBrick", 'S', Blocks.OBSIDIAN);
		...
		addShapedOreRecipe(new ItemStack(ModItems.mechanism_revolver_1, 1), " II", "ICA", "IKW", 'I', IRON.plate(), 'C', CU.ingot(), 'A', AL.ingot(), 'K', ModItems.wire_copper, 'W', ModItems.wire_aluminium);
		addShapedOreRecipe(new ItemStack(ModItems.mechanism_revolver_2, 1), " II", "ICA", "IKW", 'I', ALLOY.plate(), 'C', DURA.ingot(), 'A', W.ingot(), 'K', ModItems.bolt_dura_steel, 'W', ModItems.bolt_tungsten);
		addShapedOreRecipe(new ItemStack(ModItems.mechanism_rifle_1, 1), "ICI", "CMA", "IAM", 'I', IRON.plate(), 'C', CU.ingot(), 'A', AL.ingot(), 'M', ModItems.mechanism_revolver_1);
		addShapedOreRecipe(new ItemStack(ModItems.mechanism_rifle_2, 1), "ICI", "CMA", "IAM", 'I', ALLOY.plate(), 'C', DURA.ingot(), 'A', W.ingot(), 'M', ModItems.mechanism_revolver_2);
		...
		addShapedOreRecipe(new ItemStack(ModItems.mechanism_launcher_2, 1), "TTT", "SSS", "BBI", 'T', ALLOY.plate(), 'S', "ingotPolymer", 'B', ModItems.bolt_dura_steel, 'I', DESH.ingot());

		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.fwatz_cooler), 1), "IPI", "IPI", "IPI", 'I', "ingotTitanium", 'P', "plateTitanium");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.fwatz_tank), 1), "CGC", "GGG", "CGC", 'C', ModItems.plate_combine_steel, 'G', "paneGlass");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.fwatz_scaffold), 1), "IPI", "P P", "IPI", 'I', W.ingot(), 'P', OreDictManager.getReflector());

		addShapedRecipe(new ItemStack(ModBlocks.reinforced_stone, 4), "FBF", "BFB", "FBF", 'F', Blocks.COBBLESTONE, 'B', Blocks.STONE);
		addShapedRecipe(new ItemStack(ModBlocks.brick_light, 4), "FBF", "BFB", "FBF", 'F', Blocks.OAK_FENCE, 'B', Blocks.BRICK_BLOCK);
		...
		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_white, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeWhite");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_white);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_orange, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeOrange");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_orange);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_black, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeBlack");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_black);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_blue, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeBlue");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_blue);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_brown, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeBrown");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_brown);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_cyan, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeCyan");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_cyan);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_gray, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeGray");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_gray);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_green, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeGreen");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_green);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_light_blue, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeLightBlue");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_light_blue);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_lime, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeLime");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_lime);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_magenta, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeMagenta");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_magenta);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_pink, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyePink");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_pink);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_purple, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyePurple");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_purple);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_silver, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeLightGray");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_silver);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_red, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeRed");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_red);

		addShapelessOreRecipe(new ItemStack(ModBlocks.concrete_yellow, 8), ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, ModBlocks.concrete_smooth, "dyeYellow");
		addShapelessRecipe(new ItemStack(ModBlocks.concrete_smooth), ModBlocks.concrete_yellow);

		addShapedRecipe(new ItemStack(ModBlocks.concrete_pillar, 8), "CBC", "CBC", "CBC", 'C', ModBlocks.concrete_smooth, 'B', Blocks.IRON_BARS);
		addShapedRecipe(new ItemStack(ModBlocks.brick_concrete, 4), " C ", "CBC", " C ", 'C', ModBlocks.concrete_smooth, 'B', Items.CLAY_BALL);
		addShapedRecipe(new ItemStack(ModBlocks.brick_concrete, 4), " C ", "CBC", " C ", 'C', ModBlocks.concrete, 'B', Items.CLAY_BALL);
		addShapedRecipe(new ItemStack(ModBlocks.brick_concrete_mossy, 8), "CCC", "CVC", "CCC", 'C', ModBlocks.brick_concrete, 'V', Blocks.VINE);
		...
		addShapedRecipe(new ItemStack(ModBlocks.brick_obsidian, 4), "FBF", "BFB", "FBF", 'F', Blocks.IRON_BARS, 'B', Blocks.OBSIDIAN);
		...
		addShapedRecipe(new ItemStack(ModBlocks.meteor_brick_mossy, 8), "CCC", "CVC", "CCC", 'C', ModBlocks.meteor_brick, 'V', Blocks.VINE);
		...
		addShapedRecipe(new ItemStack(ModBlocks.tile_lab, 4), "CBC", "CBC", "CBC", 'C', Items.BRICK, 'B', ModItems.ingot_asbestos);
		...
		addShapedRecipe(new ItemStack(ModBlocks.ducrete, 4), "DD", "DD", 'D', ModBlocks.ducrete_smooth);
		addShapedRecipe(new ItemStack(ModBlocks.ducrete_brick, 4), "CDC", "DLD", "CDC", 'D', ModBlocks.ducrete_smooth, 'C', Items.CLAY_BALL, 'L', ModItems.plate_lead);
		addShapedRecipe(new ItemStack(ModBlocks.ducrete_brick, 4), "CDC", "DLD", "CDC", 'D', ModBlocks.ducrete, 'C', Items.CLAY_BALL, 'L', ModItems.plate_lead);
		addShapedRecipe(new ItemStack(ModBlocks.ducrete_reinforced, 4), "DSD", "SUS", "DSD", 'D', ModBlocks.ducrete_brick, 'S', ModItems.plate_steel, 'U', ModItems.billet_u238);
		...
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_brick), 8), "FBF", "BFB", "FBF", 'F', Blocks.IRON_BARS, 'B', ModBlocks.brick_concrete);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.brick_compound), 8), "FBF", "BFB", "FBF", 'F', ModItems.bolt_tungsten, 'B', ModBlocks.reinforced_brick);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_glass), 8), "FBF", "BFB", "FBF", 'F', Blocks.IRON_BARS, 'B', Blocks.GLASS);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_light), 1), "FFF", "FBF", "FFF", 'F', Blocks.IRON_BARS, 'B', Blocks.GLOWSTONE);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_lamp_off), 1), "FFF", "FBF", "FFF", 'F', Blocks.IRON_BARS, 'B', Blocks.REDSTONE_LAMP);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_sand), 8), "FBF", "BFB", "FBF", 'F', Blocks.IRON_BARS, 'B', Blocks.SANDSTONE);
		...
		addShapedRecipe(new ItemStack(ModBlocks.barbed_wire_wither, 8), "BBB", "BIB", "BBB", 'B', ModBlocks.barbed_wire, 'I', new ItemStack(Items.SKULL, 1, 1));
		...
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.tape_recorder), 4), "TST", "SSS", 'T', W.ingot(), 'S', "ingotSteel");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_poles), 16), "S S", "SSS", "S S", 'S', "ingotSteel");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.pole_top), 1), "T T", "TRT", "BBB", 'T', W.ingot(), 'B', ModItems.ingot_beryllium, 'R', "ingotMingrade");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.pole_satellite_receiver), 1), "SS ", "SCR", "SS ", 'S', "ingotSteel", 'C', ModItems.circuit_red_copper, 'R', ModItems.wire_red_copper);
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_beam), 8), "S", "S", "S", 'S', "ingotSteel");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_wall), 4), "SSS", "SSS", 'S', "ingotSteel");
		addShapelessRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_corner)), Item.getItemFromBlock(ModBlocks.steel_wall), Item.getItemFromBlock(ModBlocks.steel_wall));
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_roof), 2), "SSS", 'S', "ingotSteel");
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_scaffold), 8), "SSS", " S ", "SSS", 'S', "ingotSteel");

		addShapedOreRecipe(new ItemStack(ModItems.gun_rpg, 1), "SSW", " MW", 'S', ModItems.hull_small_steel, 'W', IRON.plate(), 'M', ModItems.mechanism_launcher_1);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_karl, 1), "SSW", " MW", 'S', ModItems.hull_small_steel, 'W', ALLOY.plate(), 'M', ModItems.mechanism_launcher_2);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_stinger_ammo, 4), "SS ", "STI", " IR", 'S', "plateSteel", 'T', Item.getItemFromBlock(Blocks.TNT), 'I', "plateAluminum", 'R', "dustRedstone");
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_revolver_iron, 1), "SSM", " RW", 'S', IRON.plate(), 'W', "plankWood", 'R', ModItems.wire_aluminium, 'M', ModItems.mechanism_revolver_1);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_revolver_lead, 1), "SSM", " RW", 'S', "plateLead", 'W', W.ingot(), 'R', ModItems.wire_tungsten, 'M', ModItems.mechanism_revolver_2);
		addShapedOreRecipe(new ItemStack(ModItems.gun_revolver_schrabidium, 1), "SSM", " RW", 'S', ModBlocks.block_schrabidium, 'W', W.ingot(), 'R', ModItems.wire_schrabidium, 'M', ModItems.mechanism_special);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_revolver_nightmare2, 1), "SSM", "RRW", 'S', OreDictManager.getReflector(), 'W', W.ingot(), 'R', ModItems.wire_gold, 'M', ModItems.mechanism_special);
		addShapedOreRecipe(new ItemStack(ModItems.gun_fatman, 1), "SSI", "IIM", "WPH", 'S', "plateSteel", 'I', "ingotSteel", 'W', ModItems.wire_aluminium, 'H', ModItems.hull_small_steel, 'P', Item.getItemFromBlock(Blocks.PISTON), 'M', ModItems.mechanism_launcher_2);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_thompson, 1), "IIM", " SW", " S ", 'S', IRON.plate(), 'I', "plateSteel", 'W', "plankWood", 'M', ModItems.mechanism_rifle_2);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_uboinik, 1), "IIM", "SPW", 'P', "plateSteel", 'I', "ingotSteel", 'W', "plankWood", 'S', Items.STICK, 'M', ModItems.mechanism_revolver_2);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_osipr, 1), "CCT", "WWI", "MCC", 'C', ModItems.plate_combine_steel, 'T', W.ingot(), 'W', ModItems.wire_magnetized_tungsten, 'I', ModItems.mechanism_rifle_2, 'M', ModItems.coil_magnetized_tungsten);
		addShapedOreRecipe(new ItemStack(ModItems.gun_immolator, 1), "WCC", "PMT", "WAA", 'W', ModItems.wire_gold, 'C', "plateCopper", 'P', ALLOY.plate(), 'M', ModItems.mechanism_launcher_1, 'T', ModItems.tank_steel, 'A', "plateSteel");
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_cryolator, 1), "SSS", "IWL", "LMI", 'S', "plateSteel", 'I', IRON.plate(), 'L', Items.LEATHER, 'M', ModItems.mechanism_launcher_1, 'W', ModItems.wire_aluminium);
		addShapedOreRecipe(new ItemStack(ModItems.gun_cryolator_ammo, 16), "SPS", "PCP", "SPS", 'S', "plateSteel", 'C', "dustSaltpeter", 'P', Items.SNOWBALL);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_emp, 1), "CPG", "CMF", "CPI", 'C', ModItems.coil_copper, 'P', "plateLead", 'G', ModItems.circuit_gold, 'M', ModItems.magnetron, 'I', W.ingot(), 'F', ModItems.mechanism_special);
		addShapedOreRecipe(new ItemStack(ModItems.gun_emp_ammo, 8), "IGI", "IPI", "IPI", 'G', "plateGold", 'I', IRON.plate(), 'P', ModItems.powder_power);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_hp_ammo, 8), " R ", "BSK", " Y ", 'S', "plateSteel", 'K', new ItemStack(Items.DYE, 1, 0), 'R', new ItemStack(Items.DYE, 1, 1), 'B', new ItemStack(Items.DYE, 1, 4), 'Y', new ItemStack(Items.DYE, 1, 11));
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_lever_action, 1), "PPI", "SWD", 'P', IRON.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', "plankWood", 'W', ModItems.wire_aluminium);
		addShapedOreRecipe(new ItemStack(ModItems.gun_lever_action_dark, 1), "PPI", "SWD", 'P', "plateSteel", 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', "plankWood", 'W', ModItems.wire_aluminium);
		addShapedOreRecipe(new ItemStack(ModItems.gun_bolt_action, 1), "PPI", "SWD", 'P', "plateSteel", 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', "plankWood", 'W', ModItems.wire_copper);
		addShapedOreRecipe(new ItemStack(ModItems.gun_bolt_action_green, 1), "PPI", "SWD", 'P', IRON.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', "plankWood", 'W', ModItems.wire_copper);
		addShapedOreRecipe(new ItemStack(ModItems.gun_bolt_action_saturnite, 1), "PPI", "SWD", 'P', "plateSaturnite", 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', "plankWood", 'W', ModItems.wire_tungsten);
	...
	public static void reg2(){
		...
		addShapedOreRecipe(new ItemStack(ModItems.assembly_schrabidium, 6), " I ", "GCN", " P ", 'I', "ingotSchrabidium", 'G', ModItems.cordite, 'C', ModItems.casing_357, 'P', ModItems.primer_357, 'N', Items.NETHER_STAR);
		addShapedOreRecipe(new ItemStack(ModItems.assembly_nightmare, 24), " I", "GC", " P", 'I', W.ingot(), 'G', ModItems.cordite, 'C', ModItems.casing_357, 'P', ModItems.primer_357);
		addShapedOreRecipe(new ItemStack(ModItems.assembly_desh, 24), " I", "GC", " P", 'I', DESH.ingot(), 'G', ModItems.cordite, 'C', ModItems.casing_357, 'P', ModItems.primer_357);
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_556_k, 32), "G", "C", "P", 'G', Items.GUNPOWDER, 'C', ModItems.casing_9, 'P', ModItems.primer_9);
		...
		addShapedOreRecipe(new ItemStack(ModItems.assembly_lacunae, 32), " I", "GC", " P", 'I', CU.ingot(), 'G', ModItems.cordite, 'C', ModItems.casing_9, 'P', ModItems.primer_9);
		...
		addShapedOreRecipe(new ItemStack(ModItems.ammo_dart, 16), "IPI", "ICI", "IPI", 'I', ModItems.plate_polymer, 'P', IRON.plate(), 'C', new IngredientContainsTag(ItemFluidTank.getFullBarrel(ModForgeFluids.watz)));
		...
		addShapedOreRecipe(new ItemStack(ModItems.ammo_20gauge_wither, 4), "BCB", "CAC", "BCB", 'B', ModItems.ammo_20gauge, 'A', Blocks.SOUL_SAND, 'C', "dustCoal");
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_556_tracer, 8), "BBB", "BAB", "BBB", 'B', ModItems.ammo_556, 'A', Items.REDSTONE);
		...
		addShapedOreRecipe(new ItemStack(ModItems.folly_shell, 1), "IPI", "IPI", "IMI", 'I', "ingotIron", 'P', IRON.plate(), 'M', ModItems.primer_50);
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_rocket, 1), " T ", "GCG", " P ", 'T', Blocks.TNT, 'G', ModItems.rocket_fuel, 'C', ModItems.casing_50, 'P', ModItems.primer_50);
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_rocket_glare, 1), "GGG", "GRG", "GGG", 'G', Items.REDSTONE, 'R', ModItems.ammo_rocket);
		...
		addShapedOreRecipe(new ItemStack(ModItems.ammo_grenade, 2), " T ", "GCI", " P ", 'T', Items.GUNPOWDER, 'G', ModItems.cordite, 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'I', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_grenade, 2), " T ", "GCI", " P ", 'T', Items.GUNPOWDER, 'G', ModItems.ballistite, 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'I', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_grenade_tracer, 2), " T ", "GCI", " P ", 'T', "dustLapis", 'G', ModItems.cordite, 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'I', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_grenade_tracer, 2), " T ", "GCI", " P ", 'T', "dustLapis", 'G', ModItems.ballistite, 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'I', IRON.plate());
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_grenade_concussion, 2), "GIG", 'G', ModItems.ammo_grenade, 'I', Items.GLOWSTONE_DUST);
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_grenade_finned, 1), "G", "R", 'G', Items.FEATHER, 'R', ModItems.ammo_grenade);
		...
		addShapedOreRecipe(new ItemStack(ModItems.casing_357, 1), " P ", "   ", "P P", 'P', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.casing_44, 1), "P", " ", "P", 'P', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.casing_9, 1), "P", "P", 'P', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.casing_50, 1), " P ", " P ", "PPP", 'P', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.casing_buckshot, 1), "P P", "PPP", 'P', IRON.plate());

		addShapedOreRecipe(new ItemStack(ModItems.primer_357, 1), "R", "P", 'P', IRON.plate(), 'R', "dustRedstone");
		addShapedOreRecipe(new ItemStack(ModItems.primer_44, 1), "P", "R", 'P', IRON.plate(), 'R', "dustRedstone");
		...
		addShapedOreRecipe(new ItemStack(ModItems.turret_light_ammo, 1), " L ", "IGI", "ICI", 'L', "plateLead", 'I', IRON.plate(), 'C', "plateCopper", 'G', Items.GUNPOWDER);
		addShapedOreRecipe(new ItemStack(ModItems.turret_heavy_ammo, 1), "LGC", "LGC", "LGC", 'L', "plateLead", 'C', "plateCopper", 'G', Items.GUNPOWDER);
		addShapedOreRecipe(new ItemStack(ModItems.turret_rocket_ammo, 1), "TS ", "SGS", " SR", 'T', Blocks.TNT, 'S', "plateSteel", 'G', Items.GUNPOWDER, 'R', "dustRedstone");
		...
		addShapedOreRecipe(new ItemStack(ModItems.turret_spitfire_ammo, 1), "CP ", "PTP", " PR", 'P', "plateSteel", 'C', ModItems.circuit_copper, 'T', Blocks.TNT, 'R', "dustRedstone");
		addShapedOreRecipe(new ItemStack(ModItems.turret_cwis_ammo, 1), "LLL", "GGG", "IGI", 'L', "plateLead", 'I', IRON.plate(), 'G', Items.GUNPOWDER);
		addShapedOreRecipe(new ItemStack(ModItems.turret_cheapo_ammo, 1), "ILI", "IGI", "ICI", 'L', "plateLead", 'I', "plateSteel", 'C', "plateCopper", 'G', Items.GUNPOWDER);

		addShapedOreRecipe(new ItemStack(ModItems.grenade_generic, 4), "RS ", "ITI", " I ", 'I', IRON.plate(), 'R', ModItems.wire_red_copper, 'S', "plateSteel", 'T', Item.getItemFromBlock(Blocks.TNT));
		addShapedRecipe(new ItemStack(ModItems.grenade_strong, 2), " G ", "SGS", " S ", 'G', ModItems.grenade_generic, 'S', Items.GUNPOWDER);
		addShapedRecipe(new ItemStack(ModItems.grenade_frag, 2), " G ", "WGW", " K ", 'G', ModItems.grenade_generic, 'W', Item.getItemFromBlock(Blocks.PLANKS), 'K', Item.getItemFromBlock(Blocks.GRAVEL));
		...
		addShapedRecipe(new ItemStack(ModItems.grenade_mk2, 2), " G ", "SGS", " S ", 'G', ModItems.grenade_strong, 'S', Items.GUNPOWDER);
		addShapelessRecipe(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)), Items.FLINT);
		addShapelessRecipe(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.biofuel)), Items.FLINT);
		addShapelessRecipe(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.petroil)), Items.FLINT);
		addShapelessRecipe(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.kerosene)), Items.FLINT);
		addShapelessOreRecipe(new ItemStack(ModItems.grenade_lemon, 1), ModItems.lemon, ModItems.grenade_strong);
		addShapelessRecipe(new ItemStack(ModItems.gun_moist_nugget, 12), Items.BREAD, Items.WHEAT, Items.COOKED_CHICKEN, Items.EGG);
		...
		addShapedOreRecipe(new ItemStack(ModItems.grenade_if_generic, 1), " C ", "PTP", " P ", 'C', ModItems.coil_tungsten, 'P', "plateSteel", 'T', Blocks.TNT);
		addShapedRecipe(new ItemStack(ModItems.grenade_if_he, 1), "A", "G", "A", 'G', ModItems.grenade_if_generic, 'A', Items.GUNPOWDER);
		addShapedRecipe(new ItemStack(ModItems.grenade_if_bouncy, 1), "G", "A", 'G', ModItems.grenade_if_generic, 'A', ModItems.plate_polymer);
		addShapedRecipe(new ItemStack(ModItems.grenade_if_sticky, 1), "G", "A", 'G', ModItems.grenade_if_generic, 'A', Items.SLIME_BALL);
		addShapedRecipe(new ItemStack(ModItems.grenade_if_impact, 1), "G", "A", 'G', ModItems.grenade_if_generic, 'A', Items.REDSTONE);
		addShapedRecipe(new ItemStack(ModItems.grenade_if_concussion, 1), "G", "A", 'G', ModItems.grenade_if_generic, 'A', Items.GLOWSTONE_DUST);
		...
		addShapedRecipe(new ItemStack(ModItems.grenade_if_brimstone, 1), "R", "G", "A", 'G', ModItems.grenade_if_generic, 'R', Items.REDSTONE, 'A', ModItems.sulfur);
		...
		addShapedRecipe(new ItemStack(ModItems.grenade_if_null, 1), "BAB", "AGA", "BAB", 'G', ModItems.grenade_if_generic, 'A', Blocks.OBSIDIAN, 'B', ModItems.ingot_saturnite);

		addShapedRecipe(new ItemStack(ModItems.bomb_waffle, 1), "WEW", "MPM", "WEW", 'W', Items.WHEAT, 'E', Items.EGG, 'M', Items.MILK_BUCKET, 'P', ModItems.demon_core_open);
		addShapedRecipe(new ItemStack(ModItems.schnitzel_vegan, 3), "RWR", "WPW", "RWR", 'W', ModItems.nuclear_waste, 'R', Items.REEDS, 'P', Items.PUMPKIN_SEEDS);
		addShapedRecipe(new ItemStack(ModItems.cotton_candy, 2), " S ", "SPS", " H ", 'P', ModItems.nugget_pu239, 'S', Items.SUGAR, 'H', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.apple_schrabidium, 1, 0), "SSS", "SAS", "SSS", 'S', ModItems.nugget_schrabidium, 'A', Items.APPLE);
		addShapedRecipe(new ItemStack(ModItems.apple_schrabidium1, 1, 0), "SSS", "SAS", "SSS", 'S', ModItems.ingot_schrabidium, 'A', Items.APPLE);
		addShapedRecipe(new ItemStack(ModItems.apple_schrabidium2, 1, 0), "SSS", "SAS", "SSS", 'S', Item.getItemFromBlock(ModBlocks.block_schrabidium), 'A', Items.APPLE);
		addShapedOreRecipe(new ItemStack(ModItems.apple_lead, 1, 0), "SSS", "SAS", "SSS", 'S', "nuggetLead", 'A', Items.APPLE);
		addShapedOreRecipe(new ItemStack(ModItems.apple_lead1, 1, 0), "SSS", "SAS", "SSS", 'S', "ingotLead", 'A', Items.APPLE);
		addShapedOreRecipe(new ItemStack(ModItems.apple_lead2, 1, 0), "SSS", "SAS", "SSS", 'S', "blockLead", 'A', Items.APPLE);
		addShapelessRecipe(new ItemStack(ModItems.tem_flakes, 1, 0), Items.GOLD_NUGGET, Items.PAPER);
		addShapelessRecipe(new ItemStack(ModItems.tem_flakes1, 1, 0), Items.GOLD_NUGGET, Items.GOLD_NUGGET, Items.GOLD_NUGGET, Items.PAPER);
		addShapelessRecipe(new ItemStack(ModItems.tem_flakes2, 1, 0), Items.GOLD_INGOT, Items.GOLD_INGOT, Items.GOLD_NUGGET, Items.GOLD_NUGGET, Items.PAPER);
		addShapelessRecipe(new ItemStack(ModItems.glowing_stew, 1), Items.BOWL, Item.getItemFromBlock(ModBlocks.mush), Item.getItemFromBlock(ModBlocks.mush));
		addShapelessRecipe(new ItemStack(ModItems.balefire_scrambled, 1), Items.BOWL, ModItems.egg_balefire, ModItems.powder_radspice);
		addShapelessRecipe(new ItemStack(ModItems.balefire_and_ham, 1), ModItems.balefire_scrambled, Items.COOKED_BEEF, ModItems.powder_radspice);
		addShapelessRecipe(new ItemStack(ModItems.med_ipecac, 1), Items.GLASS_BOTTLE, Items.NETHER_WART);
		addShapelessRecipe(new ItemStack(ModItems.med_ptsd, 1), ModItems.med_ipecac);
		addShapelessOreRecipe(new ItemStack(ModItems.pancake, 1), "dustRedstone", "dustDiamond", Items.WHEAT, ModItems.bolt_tungsten, ModItems.wire_copper, "plateSteel");
		addShapelessOreRecipe(new ItemStack(ModItems.pancake, 1), "dustRedstone", "dustEmerald", Items.WHEAT, ModItems.bolt_tungsten, ModItems.wire_copper, "plateSteel");

		addShapedOreRecipe(new ItemStack(ModItems.can_empty, 1), "P", "P", 'P', "plateAluminum");
		addShapelessRecipe(new ItemStack(ModItems.can_smart, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, ModItems.niter);
		addShapelessRecipe(new ItemStack(ModItems.can_creature, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)));
		addShapelessRecipe(new ItemStack(ModItems.can_redbomb, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, ModItems.pellet_cluster);
		addShapelessRecipe(new ItemStack(ModItems.can_mrsugar, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, ModItems.fluorite);
		addShapelessRecipe(new ItemStack(ModItems.can_overcharge, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, ModItems.sulfur);
		addShapelessRecipe(new ItemStack(ModItems.can_luna, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, ModItems.powder_meteorite_tiny);

		addShapedOreRecipe(new ItemStack(ModItems.canteen_13, 1), "O", "P", 'O', Items.POTIONITEM, 'P', "plateSteel");
		addShapedOreRecipe(new ItemStack(ModItems.canteen_vodka, 1), "O", "P", 'O', Items.POTATO, 'P', "plateSteel");

		addShapedOreRecipe(new ItemStack(ModItems.bottle_empty, 6), " G ", "G G", "GGG", 'G', "paneGlass");
		addShapelessOreRecipe(new ItemStack(ModItems.bottle_nuka, 1), ModItems.bottle_empty, Items.POTIONITEM, Items.SUGAR, "dustCoal");
		addShapelessRecipe(new ItemStack(ModItems.bottle_cherry, 1), ModItems.bottle_empty, Items.POTIONITEM, Items.SUGAR, Items.REDSTONE);
		addShapelessRecipe(new ItemStack(ModItems.bottle_quantum, 1), ModItems.bottle_empty, Items.POTIONITEM, Items.SUGAR, ModItems.trinitite);
		addShapedOreRecipe(new ItemStack(ModItems.bottle2_empty, 6), " G ", "G G", "G G", 'G', "paneGlass");
		addShapelessOreRecipe(new ItemStack(ModItems.bottle2_korl, 1), ModItems.bottle2_empty, Items.POTIONITEM, Items.SUGAR, "dustCopper");
		addShapelessOreRecipe(new ItemStack(ModItems.bottle2_fritz, 1), ModItems.bottle2_empty, Items.POTIONITEM, Items.SUGAR, "dustTungsten");
		addShapelessOreRecipe(new ItemStack(ModItems.bottle2_korl_special, 1), ModItems.bottle2_empty, Items.POTIONITEM, Items.SUGAR, "dustCopper", ModItems.powder_strontium);
		addShapelessOreRecipe(new ItemStack(ModItems.bottle2_fritz_special, 1), ModItems.bottle2_empty, Items.POTIONITEM, Items.SUGAR, "dustTungsten", ModItems.powder_thorium);
		addShapelessOreRecipe(new ItemStack(ModItems.bottle2_sunset, 1), ModItems.bottle2_empty, Items.POTIONITEM, Items.SUGAR, "dustGold");

		addShapedOreRecipe(new ItemStack(ModItems.syringe_empty, 6), "P", "C", "B", 'B', Item.getItemFromBlock(Blocks.IRON_BARS), 'C', new IngredientNBT2(new ItemStack(ModItems.cell)), 'P', IRON.plate());
		addShapedRecipe(new ItemStack(ModItems.syringe_antidote, 6), "SSS", "PMP", "SSS", 'S', ModItems.syringe_empty, 'P', Items.PUMPKIN_SEEDS, 'M', Items.MILK_BUCKET);
		addShapedRecipe(new ItemStack(ModItems.syringe_antidote, 6), "SPS", "SMS", "SPS", 'S', ModItems.syringe_empty, 'P', Items.PUMPKIN_SEEDS, 'M', Items.MILK_BUCKET);
		addShapedRecipe(new ItemStack(ModItems.syringe_antidote, 6), "SSS", "PMP", "SSS", 'S', ModItems.syringe_empty, 'P', Items.PUMPKIN_SEEDS, 'M', Items.REEDS);
		addShapedRecipe(new ItemStack(ModItems.syringe_antidote, 6), "SPS", "SMS", "SPS", 'S', ModItems.syringe_empty, 'P', Items.PUMPKIN_SEEDS, 'M', Items.REEDS);
		addShapedOreRecipe(new ItemStack(ModItems.syringe_poison, 1), "SLS", "LCL", "SLS", 'C', ModItems.syringe_empty, 'S', Items.SPIDER_EYE, 'L', "dustLead");
		addShapedRecipe(new ItemStack(ModItems.syringe_poison, 1), "SLS", "LCL", "SLS", 'C', ModItems.syringe_empty, 'S', Items.SPIDER_EYE, 'L', ModItems.powder_poison);
		...
		addShapedOreRecipe(new ItemStack(ModItems.syringe_metal_empty, 6), "P", "C", "B", 'B', Item.getItemFromBlock(Blocks.IRON_BARS), 'C', ModItems.rod_empty, 'P', IRON.plate());
		addShapedRecipe(new ItemStack(ModItems.syringe_metal_stimpak, 1), " N ", "NSN", " N ", 'N', Items.NETHER_WART, 'S', ModItems.syringe_metal_empty);
		addShapedRecipe(new ItemStack(ModItems.syringe_metal_medx, 1), " N ", "NSN", " N ", 'N', Items.QUARTZ, 'S', ModItems.syringe_metal_empty);
		addShapedRecipe(new ItemStack(ModItems.syringe_metal_psycho, 1), " N ", "NSN", " N ", 'N', Items.GLOWSTONE_DUST, 'S', ModItems.syringe_metal_empty);
		...
		addShapelessOreRecipe(new ItemStack(ModItems.radx, 1), "dustCoal", "dustCoal", "dustFluorite");
		addShapedRecipe(new ItemStack(ModItems.med_bag, 1), "LLL", "SIS", "LLL", 'L', Items.LEATHER, 'S', ModItems.syringe_metal_stimpak, 'I', ModItems.syringe_antidote);
		addShapedRecipe(new ItemStack(ModItems.med_bag, 1), "LLL", "SIS", "LLL", 'L', Items.LEATHER, 'S', ModItems.syringe_metal_stimpak, 'I', ModItems.pill_iodine);
		addShapedRecipe(new ItemStack(ModItems.med_bag, 1), "LL", "SI", "LL", 'L', Items.LEATHER, 'S', ModItems.syringe_metal_super, 'I', ModItems.radaway);
		...
		addShapedOreRecipe(new ItemStack(ModItems.syringe_metal_super, 1), " N ", "PSP", "L L", 'N', ModItems.bottle_nuka, 'P', "plateSteel", 'S', ModItems.syringe_metal_stimpak, 'L', Items.LEATHER);
		...
		addShapedOreRecipe(new ItemStack(ModItems.syringe_metal_super, 1), " N ", "PSP", "L L", 'N', ModItems.bottle_cherry, 'P', "plateSteel", 'S', ModItems.syringe_metal_stimpak, 'L', Items.LEATHER);
		...
		addShapelessRecipe(new ItemStack(ModItems.radaway, 1), ModItems.powder_coal, Items.PUMPKIN_SEEDS, Items.GLASS_BOTTLE);
		addShapelessRecipe(new ItemStack(ModItems.radaway_strong, 1), ModBlocks.mush, ModItems.radaway);
		addShapelessRecipe(new ItemStack(ModItems.radaway_flush, 1), ModItems.powder_iodine, ModItems.radaway_strong);

		addShapedOreRecipe(new ItemStack(ModItems.stealth_boy, 1), " B", "LI", "LC", 'B', Item.getItemFromBlock(Blocks.STONE_BUTTON), 'L', Items.LEATHER, 'I', "ingotSteel", 'C', ModItems.circuit_red_copper);

		addShapedOreRecipe(new ItemStack(ModBlocks.sat_dock, 1), "SSS", "PCP", 'S', "ingotSteel", 'P', "ingotPolymer", 'C', ModBlocks.crate_iron);
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.book_guide), 1), "IBI", "LBL", "IBI", 'B', Items.BOOK, 'I', new ItemStack(Items.DYE, 1, 0), 'L', new ItemStack(Items.DYE, 1, 4));

		addShapedOreRecipe(new ItemStack(ModBlocks.rail_highspeed, 16), "S S", "SIS", "S S", 'S', "ingotSteel", 'I', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModBlocks.rail_booster, 6), "S S", "CIC", "SRS", 'S', "ingotSteel", 'I', IRON.plate(), 'R', "ingotMingrade", 'C', ModItems.coil_copper);

		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.bomb_multi), 1), "AAD", "CHF", "AAD", 'A', ModItems.wire_aluminium, 'C', ModItems.circuit_aluminium, 'H', ModItems.hull_small_aluminium, 'F', ModItems.fins_quad_titanium, 'D', new ItemStack(Items.DYE, 1, 15));
		addShapelessOreRecipe(new ItemStack(ModItems.powder_ice, 4), Items.SNOWBALL, "dustSaltpeter", "dustRedstone");
		addShapelessOreRecipe(new ItemStack(ModItems.powder_poison, 4), Items.SPIDER_EYE, "dustRedstone", "gemQuartz");
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_gas, 2), Items.WATER_BUCKET, "dustGlowstone", "plateSteel", ModItems.ingot_iodine);

		addShapedRecipe(new ItemStack(ModItems.flame_pony, 1), " O ", "DPD", " O ", 'D', new ItemStack(Items.DYE, 1, 11), 'O', new ItemStack(Items.DYE, 1, 9), 'P', Items.PAPER);
		...
		addShapedRecipe(new ItemStack(ModItems.flame_politics, 1), " I ", "IPI", " I ", 'P', Items.PAPER, 'I', new ItemStack(Items.DYE, 1, 0));
		addShapedRecipe(new ItemStack(ModItems.flame_opinion, 1), " R ", "RPR", " R ", 'P', Items.PAPER, 'R', new ItemStack(Items.DYE, 1, 1));

		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.flame_war), 1), "WHW", "CTP", "WOW", 'W', Item.getItemFromBlock(Blocks.PLANKS), 'T', Item.getItemFromBlock(Blocks.TNT), 'H', ModItems.flame_pony, 'C', ModItems.flame_conspiracy, 'P', ModItems.flame_politics, 'O', ModItems.flame_opinion);
		addShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.emp_bomb), 1), "LML", "LCL", "LML", 'L', "plateLead", 'M', ModItems.magnetron, 'C', ModItems.circuit_gold);
		...
		addShapedOreRecipe(new ItemStack(ModItems.custom_tnt, 1), " C ", "TIT", "TIT", 'C', "plateCopper", 'I', IRON.plate(), 'T', Blocks.TNT);
		addShapedOreRecipe(new ItemStack(ModItems.custom_nuke, 1), " C ", "LUL", "LUL", 'C', "plateCopper", 'L', "plateLead", 'U', "ingotUranium235");
		addShapedOreRecipe(new ItemStack(ModItems.custom_hydro, 1), " C ", "LTL", "LIL", 'C', "plateCopper", 'L', "plateLead", 'I', IRON.plate(), 'T', new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.tritium)));
		...
		addShapedOreRecipe(ItemBattery.getFullBattery(ModItems.battery_su), "P", "R", "C", 'P', Items.PAPER, 'R', "dustRedstone", 'C', "dustCoal");
		addShapedOreRecipe(ItemBattery.getFullBattery(ModItems.battery_su), "P", "C", "R", 'P', Items.PAPER, 'R', "dustRedstone", 'C', "dustCoal");
		addShapedOreRecipe(ItemBattery.getFullBattery(ModItems.battery_su_l), " W ", "CPC", "RPR", 'W', ModItems.wire_aluminium, 'P', Items.PAPER, 'R', "dustRedstone", 'C', "dustCoal");
		addShapedOreRecipe(ItemBattery.getFullBattery(ModItems.battery_su_l), " W ", "RPR", "CPC", 'W', ModItems.wire_aluminium, 'P', Items.PAPER, 'R', "dustRedstone", 'C', "dustCoal");
		addShapedOreRecipe(ItemBattery.getFullBattery(ModItems.battery_su_l), " W ", "CPC", "RPR", 'W', ModItems.wire_copper, 'P', Items.PAPER, 'R', "dustRedstone", 'C', "dustCoal");
		addShapedOreRecipe(ItemBattery.getFullBattery(ModItems.battery_su_l), " W ", "RPR", "CPC", 'W', ModItems.wire_copper, 'P', Items.PAPER, 'R', "dustRedstone", 'C', "dustCoal");
		addShapelessRecipe(ItemBattery.getFullBattery(ModItems.battery_potato), Items.POTATO, ModItems.wire_aluminium, ModItems.wire_copper);
		...
		if(GeneralConfig.enableBabyMode) {
			...
			addShapedRecipe(new ItemStack(ModItems.schrabidium_sword, 1), "I", "I", "S", 'I', ModItems.ingot_schrabidium, 'S', Items.STICK);
			addShapedRecipe(new ItemStack(ModItems.schrabidium_pickaxe, 1), "III", " S ", " S ", 'I', ModItems.ingot_schrabidium, 'S', Items.STICK);
			addShapedRecipe(new ItemStack(ModItems.schrabidium_axe, 1), "II", "IS", " S", 'I', ModItems.ingot_schrabidium, 'S', Items.STICK);
			addShapedRecipe(new ItemStack(ModItems.schrabidium_shovel, 1), "I", "S", "S", 'I', ModItems.ingot_schrabidium, 'S', Items.STICK);
			addShapedRecipe(new ItemStack(ModItems.schrabidium_hoe, 1), "II", " S", " S", 'I', ModItems.ingot_schrabidium, 'S', Items.STICK);
		} else {
		...
		addShapedOreRecipe(new ItemStack(ModItems.steel_sword, 1), "I", "I", "S", 'I', "ingotSteel", 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.steel_pickaxe, 1), "III", " S ", " S ", 'I', "ingotSteel", 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.steel_axe, 1), "II", "IS", " S", 'I', "ingotSteel", 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.steel_shovel, 1), "I", "S", "S", 'I', "ingotSteel", 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.steel_hoe, 1), "II", " S", " S", 'I', "ingotSteel", 'S', Items.STICK);
		...
		addShapedRecipe(new ItemStack(ModItems.titanium_sword, 1), "I", "I", "S", 'I', ModItems.ingot_titanium, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.titanium_pickaxe, 1), "III", " S ", " S ", 'I', ModItems.ingot_titanium, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.titanium_axe, 1), "II", "IS", " S", 'I', ModItems.ingot_titanium, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.titanium_shovel, 1), "I", "S", "S", 'I', ModItems.ingot_titanium, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.titanium_hoe, 1), "II", " S", " S", 'I', ModItems.ingot_titanium, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cobalt_sword, 1), "I", "I", "S", 'I', ModItems.ingot_cobalt, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cobalt_pickaxe, 1), "III", " S ", " S ", 'I', ModItems.ingot_cobalt, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cobalt_axe, 1), "II", "IS", " S", 'I', ModItems.ingot_cobalt, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cobalt_shovel, 1), "I", "S", "S", 'I', ModItems.ingot_cobalt, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cobalt_hoe, 1), "II", " S", " S", 'I', ModItems.ingot_cobalt, 'S', Items.STICK);
		...
		addShapedRecipe(new ItemStack(ModItems.alloy_sword, 1), "I", "I", "S", 'I', ModItems.ingot_advanced_alloy, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.alloy_pickaxe, 1), "III", " S ", " S ", 'I', ModItems.ingot_advanced_alloy, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.alloy_axe, 1), "II", "IS", " S", 'I', ModItems.ingot_advanced_alloy, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.alloy_shovel, 1), "I", "S", "S", 'I', ModItems.ingot_advanced_alloy, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.alloy_hoe, 1), "II", " S", " S", 'I', ModItems.ingot_advanced_alloy, 'S', Items.STICK);
		...
		addShapedRecipe(new ItemStack(ModItems.cmb_sword, 1), "I", "I", "S", 'I', ModItems.ingot_combine_steel, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cmb_pickaxe, 1), "III", " S ", " S ", 'I', ModItems.ingot_combine_steel, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cmb_axe, 1), "II", "IS", " S", 'I', ModItems.ingot_combine_steel, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cmb_shovel, 1), "I", "S", "S", 'I', ModItems.ingot_combine_steel, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.cmb_hoe, 1), "II", " S", " S", 'I', ModItems.ingot_combine_steel, 'S', Items.STICK);
		...
		addShapelessRecipe(new ItemStack(ModItems.centri_stick, 1), ModItems.centrifuge_element, ModItems.energy_core, Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.smashing_hammer, 1), "STS", "SPS", " P ", 'S', "blockSteel", 'T', "blockTungsten", 'P', "ingotPolymer");
		addShapedRecipe(new ItemStack(ModItems.desh_sword, 1), "I", "I", "S", 'I', ModItems.ingot_desh, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.desh_pickaxe, 1), "III", " S ", " S ", 'I', ModItems.ingot_desh, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.desh_axe, 1), "II", "IS", " S", 'I', ModItems.ingot_desh, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.desh_shovel, 1), "I", "S", "S", 'I', ModItems.ingot_desh, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.desh_hoe, 1), "II", " S", " S", 'I', ModItems.ingot_desh, 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.security_helmet, 1), "SSS", "IGI", 'S', "plateSteel", 'I', ModItems.plate_polymer, 'G', "paneGlass");
		addShapedRecipe(new ItemStack(ModItems.security_plate, 1), "KWK", "IKI", "WKW", 'K', ModItems.plate_kevlar, 'I', ModItems.ingot_polymer, 'W', new ItemStack(Blocks.WOOL, 1, OreDictionary.WILDCARD_VALUE));
		addShapedRecipe(new ItemStack(ModItems.security_legs, 1), "IWI", "K K", "W W", 'K', ModItems.plate_kevlar, 'I', ModItems.ingot_polymer, 'W', new ItemStack(Blocks.WOOL, 1, OreDictionary.WILDCARD_VALUE));
		addShapedOreRecipe(new ItemStack(ModItems.security_boots, 1), "P P", "I I", 'P', "plateSteel", 'I', ModItems.plate_polymer);

		addShapedOreRecipe(new ItemStack(ModItems.jetpack_boost, 1), "PTP", "SLS", "W W", 'P', "plateSteel", 'T', ModItems.tank_steel, 'S', ModItems.pipes_steel, 'L', Items.LEATHER, 'W', ModItems.thruster_small);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gas_mask_filter, 1), "F", "I", "F", 'F', ModItems.filter_coal, 'I', IRON.plate());
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_kit_1, 4), "I ", "LB", "P ", 'I', ModItems.plate_polymer, 'L', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.lubricant)), 'B', ModItems.bolt_tungsten, 'P', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.gun_kit_2, 1), "III", "GLG", "PPP", 'I', ModItems.plate_polymer, 'L', ModItems.ducttape, 'G', ModItems.gun_kit_1, 'P', IRON.plate());
		...
		addShapedRecipe(new ItemStack(ModItems.watch, 1), "LEL", "EWE", "LEL", 'E', ModItems.ingot_euphemium, 'L', new ItemStack(Items.DYE, 1, 4), 'W', Items.CLOCK);
		addShapedRecipe(new ItemStack(ModItems.apple_euphemium, 1), "EEE", "EAE", "EEE", 'E', ModItems.nugget_euphemium, 'A', Items.APPLE);
		addShapedRecipe(new ItemStack(ModItems.plate_euphemium, 1), "AEA", "ENE", "AEA", 'E', ModItems.ingot_euphemium, 'N', Items.NETHER_STAR, 'A', ModItems.powder_astatine);

		addShapedOreRecipe(new ItemStack(ModItems.mask_of_infamy, 1), "III", "III", " I ", 'I', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.designator, 1), "  A", "#B#", "#B#", '#', IRON.plate(), 'A', "plateSteel", 'B', ModItems.circuit_red_copper);
		addShapedOreRecipe(new ItemStack(ModItems.designator_range, 1), "RRD", "PIC", "  P", 'P', "plateSteel", 'R', Items.REDSTONE, 'C', ModItems.circuit_gold, 'D', ModItems.designator, 'I', "ingotSteel");
		...
		addShapedOreRecipe(new ItemStack(ModItems.linker, 1), "I I", "ICI", "GGG", 'I', IRON.plate(), 'G', "plateGold", 'C', ModItems.circuit_gold);
		addShapedOreRecipe(new ItemStack(ModItems.oil_detector, 1), "W I", "WCI", "PPP", 'W', ModItems.wire_gold, 'I', CU.ingot(), 'C', ModItems.circuit_red_copper, 'P', "plateSteel");
		...
		addShapedOreRecipe(new ItemStack(ModItems.dosimeter, 1), "WGW", "WCW", "WBW", 'W', "plankWood", 'G', "paneGlass", 'C', ModItems.circuit_aluminium, 'B', "ingotBeryllium");
		addShapedRecipe(new ItemStack(ModItems.digamma_diagnostic), "GPP", "WCS", "WBB", 'W', ModItems.wire_tungsten, 'P', ModItems.ingot_reiium, 'C', ModItems.circuit_schrabidium, 'G', ModItems.ingot_caesium, 'S', ModItems.plate_desh, 'B', ModItems.ingot_i131);
		addShapedRecipe(new ItemStack(ModItems.lung_diagnostic, 1), "WGW", "WCW", "WBW", 'W', AL.ingot(), 'G', ModItems.gas_mask_filter, 'C', ModItems.ingot_asbestos, 'B', ModItems.circuit_red_copper);
		...
		addShapedOreRecipe(new ItemStack(ModItems.key_red, 1), "DSC", "SMS", "KSD", 'C', ModItems.circuit_targeting_tier4, 'M', Items.NETHER_STAR, 'K', ModItems.key, 'D', DESH.dust(), 'S', "plateSaturnite");
		...
		addShapedOreRecipe(new ItemStack(ModItems.padlock_reinforced, 1), " P ", "PBP", "PDP", 'P', ALLOY.plate(), 'D', ModItems.plate_desh, 'B', ModItems.bolt_dura_steel);
		...
		addShapedRecipe(new ItemStack(ModItems.euphemium_stopper, 1), "I", "S", "S", 'I', ModItems.ingot_euphemium, 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.matchstick, 16), "I", "S", 'I', "sulfur", 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(ModItems.matchstick, 16), "I", "S", 'I', "dustSulfur", 'S', Items.STICK);
		addShapedRecipe(new ItemStack(ModItems.matchstick, 24), "I", "S", 'I', ModItems.powder_fire, 'S', Items.STICK);
		...
		addShapelessOreRecipe(new ItemStack(ModItems.ballistite, 3), Items.GUNPOWDER, "dustSaltpeter", Items.SUGAR);
		...
		addShapelessOreRecipe(new ItemStack(ModItems.powder_spark_mix, 5), DESH.dust(), "dustEuphemium", ModItems.powder_meteorite, ModItems.powder_power, ModItems.powder_nitan_mix);
		...
		addShapedOreRecipe(new ItemStack(ModItems.saw, 1), "IIL", "PP ", 'P', "plateSteel", 'I', "ingotSteel", 'L', Items.LEATHER);
		...
		addShapedOreRecipe(new ItemStack(ModItems.polaroid, 1), " C ", "RPY", " B ", 'B', "dustLapis", 'C', "dustCoal", 'R', "dustAdvanced", 'Y', "dustGold", 'P', Items.PAPER);

		addShapedOreRecipe(new ItemStack(ModItems.ullapool_caber, 1), "ITI", " S ", " S ", 'I', IRON.plate(), 'T', Blocks.TNT, 'S', Items.STICK);
		addShapelessOreRecipe(new ItemStack(ModItems.chocolate_milk, 1), "paneGlass", new ItemStack(Items.DYE, 1, 3), Items.MILK_BUCKET, ModBlocks.block_niter, ModItems.sulfur, ModItems.sulfur, ModItems.sulfur, ModItems.powder_fire);

		addShapelessRecipe(new ItemStack(ModItems.crystal_horn, 1), ModItems.powder_neptunium, ModItems.powder_iodine, ModItems.powder_thorium, ModItems.powder_astatine, ModItems.powder_neodymium, ModItems.powder_caesium, ModBlocks.block_meteor, ModBlocks.gravel_obsidian, Items.WATER_BUCKET);
		addShapelessRecipe(new ItemStack(ModItems.crystal_charred, 1), ModItems.powder_strontium, ModItems.powder_cobalt, ModItems.powder_bromine, ModItems.powder_niobium, ModItems.powder_tennessine, ModItems.powder_cerium, ModBlocks.block_meteor, ModBlocks.block_aluminium, Items.WATER_BUCKET);
		...
		addShapedRecipe(new ItemStack(ModItems.template_folder, 1), "LPL", "BPB", "LPL", 'P', Items.PAPER, 'L', new ItemStack(Items.DYE, 1, 4), 'B', new ItemStack(Items.DYE, 1, 15));
		addShapedOreRecipe(new ItemStack(ModItems.turret_control, 1), "R12", "PPI", "  I", 'R', Items.REDSTONE, '1', ModItems.circuit_aluminium, '2', ModItems.circuit_red_copper, 'P', "plateSteel", 'I', "ingotSteel");
		...
		addShapedOreRecipe(new ItemStack(ModItems.fluid_tank_full, 8), "121", "1 1", "121", '1', "plateAluminum", '2', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.fluid_barrel_full, 2), "121", "1 1", "121", '1', "plateSteel", '2', "plateAluminum");
		addShapedOreRecipe(new ItemStack(ModItems.inf_water, 1), "222", "131", "222", '1', Items.WATER_BUCKET, '2', "plateAluminum", '3', Items.DIAMOND);
		addShapelessRecipe(new ItemStack(ModItems.powder_desh_mix, 1), ModItems.powder_boron_tiny, ModItems.powder_actinium_tiny, ModItems.powder_lanthanium_tiny, ModItems.powder_lanthanium_tiny, ModItems.powder_cerium_tiny, ModItems.powder_cobalt_tiny, ModItems.powder_lithium_tiny, ModItems.powder_neodymium_tiny, ModItems.powder_niobium_tiny);
		addShapelessRecipe(new ItemStack(ModItems.powder_desh_mix, 9), ModItems.powder_boron, ModItems.powder_actinium, ModItems.powder_lanthanium, ModItems.powder_lanthanium, ModItems.powder_cerium, ModItems.powder_cobalt, ModItems.powder_lithium, ModItems.powder_neodymium, ModItems.powder_niobium);
		...
		addShapedOreRecipe(ItemBattery.getEmptyBattery(ModItems.dynosphere_desh), "RPR", "PBP", "RPR", 'R', ModItems.powder_desh_mix, 'P', DESH.ingot(), 'B', ModItems.dynosphere_base);
		...
		addShapedOreRecipe(new ItemStack(ModItems.plate_dineutronium, 4), "PIP", "IDI", "PIP", 'P', ModItems.powder_spark_mix, 'I', "ingotDineutronium", 'D', DESH.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.plate_desh, 4), "PIP", "IDI", "PIP", 'P', ModItems.powder_polymer, 'I', DESH.ingot(), 'D', DURA.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.piston_selenium, 1), "SSS", "STS", " D ", 'S', "plateSteel", 'T', W.ingot(), 'D', ModItems.bolt_dura_steel);
		addShapelessOreRecipe(new ItemStack(ModItems.catalyst_clay), "dustIron", Items.CLAY_BALL);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_keyforge), "PCP", "WSW", "WSW", 'P', "plateSteel", 'S', W.ingot(), 'C', ModItems.padlock, 'W', "plankWood");
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_transformer_dnt), "SDS", "MCM", "MCM", 'S', ModItems.ingot_starmetal, 'D', DESH.ingot(), 'M', ModBlocks.fwatz_conductor, 'C', ModItems.circuit_targeting_tier6);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_transformer_dnt_20), "SDS", "MCM", "MCM", 'S', ModItems.ingot_starmetal, 'D', DESH.ingot(), 'M', ModBlocks.fusion_conductor, 'C', ModItems.circuit_targeting_tier6);
		addShapelessRecipe(new ItemStack(ModItems.bottle_sparkle), ModItems.bottle_nuka, Items.CARROT, Items.GOLD_NUGGET);
		addShapelessRecipe(new ItemStack(ModItems.bottle_rad), ModItems.bottle_quantum, Items.CARROT, Items.GOLD_NUGGET, ModItems.powder_radspice);
		addShapedOreRecipe(new ItemStack(ModItems.grenade_nuke), "CGC", "CGC", "PAP", 'C', ModBlocks.det_charge, 'G', ModItems.grenade_mk2, 'P', ALLOY.plate(), 'A', Blocks.ANVIL);
		...
		addShapedOreRecipe(new ItemStack(ModItems.jackt), "S S", "LIL", "LIL", 'S', "plateSteel", 'L', Items.LEATHER, 'I', ModItems.plate_polymer);
		addShapedOreRecipe(new ItemStack(ModItems.jackt2), "S S", "LIL", "III", 'S', "plateSteel", 'L', Items.LEATHER, 'I', ModItems.plate_polymer);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.vent_chlorine), "IGI", "ICI", "IDI", 'I', IRON.plate(), 'G', Blocks.IRON_BARS, 'C', ModItems.pellet_gas, 'D', Blocks.DISPENSER);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.vent_cloud), "IGI", "ICI", "IDI", 'I', IRON.plate(), 'G', Blocks.IRON_BARS, 'C', ModItems.grenade_cloud, 'D', Blocks.DISPENSER);
		addShapedOreRecipe(new ItemStack(ModBlocks.vent_pink_cloud), "IGI", "ICI", "IDI", 'I', IRON.plate(), 'G', Blocks.IRON_BARS, 'C', ModItems.grenade_pink_cloud, 'D', Blocks.DISPENSER);
		addShapedOreRecipe(new ItemStack(ModBlocks.spikes, 4), "FFF", "BBB", "TTT", 'F', Items.FLINT, 'B', ModItems.bolt_tungsten, 'T', W.ingot());
		addShapedOreRecipe(new ItemStack(ModBlocks.mine_ap, 4), "C", "P", "T", 'C', ModItems.circuit_targeting_tier2, 'P', IRON.plate(), 'T', ModItems.ingot_semtex);
		...
		addShapelessOreRecipe(new ItemStack(ModItems.syringe_taint), ModItems.bottle2_empty, ModItems.syringe_metal_empty, ModItems.ducttape, ModItems.powder_magic, "nuggetSchrabidium", Items.POTIONITEM);
		addShapelessRecipe(new ItemStack(ModItems.loops), ModItems.flame_pony, Items.WHEAT, Items.SUGAR);
		addShapelessRecipe(new ItemStack(ModItems.loop_stew), ModItems.loops, ModItems.can_smart, Items.BOWL);
		addShapedOreRecipe(new ItemStack(ModItems.gun_calamity, 1), " PI", "BBM", " PI", 'P', IRON.plate(), 'B', ModItems.pipes_steel, 'M', ModItems.mechanism_rifle_1, 'I', "ingotSteel");
		addShapedOreRecipe(new ItemStack(ModItems.gun_calamity_dual, 1), "BBM", " PI", "BBM", 'P', IRON.plate(), 'B', ModItems.pipes_steel, 'M', ModItems.mechanism_rifle_1, 'I', "ingotSteel");
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_avenger, 1), "PIB", "PCM", "PIB", 'P', ModItems.pipes_steel, 'B', "blockBeryllium", 'I', DESH.ingot(), 'C', ModItems.mechanism_rifle_2, 'M', ModItems.motor);
		...
		addShapedOreRecipe(new ItemStack(ModItems.containment_box, 1), "LLL", "LCL", "LLL", 'L', "plateLead", 'C', Blocks.CHEST);

		addShapedOreRecipe(new ItemStack(ModBlocks.absorber, 1), "ICI", "CPC", "ICI", 'I', CU.ingot(), 'C', "dustCoal", 'P', "dustLead");
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.decon, 1), "BGB", "SAS", "BSB", 'B', "ingotBeryllium", 'G', Blocks.IRON_BARS, 'S', "ingotSteel", 'A', ModBlocks.absorber);
		addShapedRecipe(new ItemStack(ModBlocks.decon_digamma, 1), "BGB", "SAS", "BTB", 'S', ModItems.billet_flashlead, 'G', ModItems.fmn, 'B', ModItems.plate_desh, 'A', ModBlocks.decon, 'T', ModItems.xanax);
		addShapedOreRecipe(new ItemStack(ModBlocks.radsensor, 1), "IGI", "LCL", "IRI", 'I', ModItems.ingot_cerium, 'L', ModItems.plate_lead, 'G', ModItems.geiger_counter, 'C', Items.COMPARATOR, 'R', Items.REDSTONE);
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_geo, 1), "ITI", "PCP", "ITI", 'I', DURA.ingot(), 'T', ModItems.thermo_element, 'P', ModItems.board_copper, 'C', ModBlocks.red_wire_coated);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_minirtg, 1), "LLL", "PPP", "TRT", 'L', "plateLead", 'P', ModItems.billet_pu238, 'T', ModItems.thermo_element, 'R', ModItems.rtg_unit);
		...
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg), ModItems.billet_pu238, ModItems.billet_pu238, ModItems.billet_pu238, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_radium), ModItems.billet_ra226, ModItems.billet_ra226, ModItems.billet_ra226, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_weak), ModItems.billet_u238, ModItems.billet_u238, ModItems.billet_pu238, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_strontium), ModItems.billet_sr90, ModItems.billet_sr90, ModItems.billet_sr90, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_cobalt), ModItems.billet_co60, ModItems.billet_co60, ModItems.billet_co60, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_actinium), ModItems.billet_ac227, ModItems.billet_ac227, ModItems.billet_ac227, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_polonium), ModItems.billet_polonium, ModItems.billet_polonium, ModItems.billet_polonium, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_lead), ModItems.billet_pb209, ModItems.billet_pb209, ModItems.billet_pb209, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_gold), ModItems.billet_au198, ModItems.billet_au198, ModItems.billet_au198, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_americium), ModItems.billet_am241, ModItems.billet_am241, ModItems.billet_am241, IRON.plate());
		addShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_balefire), ModItems.egg_balefire, ModItems.egg_balefire, ModItems.egg_balefire, IRON.plate());

		addShapelessRecipe(new ItemStack(ModItems.billet_bismuth, 3), new ItemStack(ModItems.pellet_rtg_depleted_bismuth));
		addShapelessRecipe(new ItemStack(ModItems.ingot_lead, 2), new ItemStack(ModItems.pellet_rtg_depleted_lead));
		addShapelessRecipe(new ItemStack(ModItems.nugget_mercury, 12), new ItemStack(ModItems.pellet_rtg_depleted_mercury));
		addShapelessRecipe(new ItemStack(ModItems.billet_neptunium, 3), new ItemStack(ModItems.pellet_rtg_depleted_neptunium));
		addShapelessRecipe(new ItemStack(ModItems.billet_zirconium, 3), new ItemStack(ModItems.pellet_rtg_depleted_zirconium));

		addShapedRecipe(new ItemStack(ModBlocks.pink_planks, 4), "W", 'W', ModBlocks.pink_log);
		addShapedRecipe(new ItemStack(ModItems.decontamination_module, 1), "GAG", "WTW", "GAG", 'W', ModItems.ingot_actinium, 'T', ModBlocks.decon, 'G', ModItems.nugget_polonium, 'A', ModItems.ingot_magnetized_tungsten);

		addShapedOreRecipe(new ItemStack(ModItems.door_metal, 1), "II", "SS", "II", 'I', IRON.plate(), 'S', "plateSteel");
		addShapedOreRecipe(new ItemStack(ModItems.door_office, 1), "II", "SS", "II", 'I', "plankWood", 'S', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.door_bunker, 1), "II", "SS", "II", 'I', "plateSteel", 'S', "plateLead");

		addShapelessRecipe(new ItemStack(Items.PAPER, 1), new ItemStack(ModItems.assembly_template, 1, OreDictionary.WILDCARD_VALUE));
		addShapelessRecipe(new ItemStack(Items.PAPER, 1), new ItemStack(ModItems.chemistry_template, 1, OreDictionary.WILDCARD_VALUE));

		for(Entry<String, Fluid> entry : FluidRegistry.getRegisteredFluids().entrySet()) {
			Fluid fluid = entry.getValue();
			addShapelessRecipe(ItemFFFluidDuct.getStackFromFluid(fluid), new ItemStack(ModBlocks.fluid_duct_mk2, 1), new IngredientContainsTag(ItemForgeFluidIdentifier.getStackFromFluid(entry.getValue())));
			...
			addShapelessRecipe(ItemFFFluidDuct.getStackFromFluid(fluid), new ItemStack(ModItems.ff_fluid_duct, 1, OreDictionary.WILDCARD_VALUE), new IngredientContainsTag(ItemForgeFluidIdentifier.getStackFromFluid(entry.getValue())));
		...
		addShapelessRecipe(new ItemStack(ModBlocks.fluid_duct_mk2, 1), new ItemStack(ModItems.ff_fluid_duct, 1, OreDictionary.WILDCARD_VALUE));

		addShapelessRecipe(new ItemStack(ModItems.redstone_depleted, 1), new ItemStack(ModItems.battery_su, 1, OreDictionary.WILDCARD_VALUE));
		addShapelessRecipe(new ItemStack(ModItems.redstone_depleted, 2), new ItemStack(ModItems.battery_su_l, 1, OreDictionary.WILDCARD_VALUE));
		addShapelessRecipe(new ItemStack(Items.REDSTONE, 1), ModItems.redstone_depleted, ModItems.redstone_depleted);

		addShapelessRecipe(new ItemStack(ModItems.bobmazon_materials), Items.BOOK, Items.GOLD_NUGGET, Items.STRING);
		addShapelessRecipe(new ItemStack(ModItems.bobmazon_machines), Items.BOOK, Items.GOLD_NUGGET, new ItemStack(Items.DYE, 1, 1));
		addShapelessRecipe(new ItemStack(ModItems.bobmazon_weapons), Items.BOOK, Items.GOLD_NUGGET, new ItemStack(Items.DYE, 1, 8));
		addShapelessRecipe(new ItemStack(ModItems.bobmazon_tools), Items.BOOK, Items.GOLD_NUGGET, new ItemStack(Items.DYE, 1, 2));

		addShapedRecipe(new ItemStack(Blocks.TORCH, 3), "L", "S", 'L', ModItems.lignite, 'S', Items.STICK);
		addShapedRecipe(new ItemStack(Blocks.TORCH, 6), "L", "S", 'L', ModItems.briquette_lignite, 'S', Items.STICK);
		addShapedOreRecipe(new ItemStack(Blocks.TORCH, 8), "L", "S", 'L', "fuelCoke", 'S', Items.STICK);
		...
		addShapedOreRecipe(new ItemStack(ModItems.mp_fuselage_10_kerosene_metal, 1), "ICI", "CTC", "ICI", 'C', "plateSteel", 'I', IRON.plate(), 'T', ModItems.mp_fuselage_10_kerosene);
		addShapedOreRecipe(new ItemStack(ModItems.mp_fuselage_10_long_kerosene_metal, 1), "ICI", "CTC", "ICI", 'C', "plateSteel", 'I', IRON.plate(), 'T', ModItems.mp_fuselage_10_long_kerosene);
		addShapedOreRecipe(new ItemStack(ModItems.mp_fuselage_15_kerosene_metal, 1), "ICI", "CTC", "ICI", 'C', "plateSteel", 'I', IRON.plate(), 'T', ModItems.mp_fuselage_15_kerosene);
		...
		addShapedRecipe(new ItemStack(ModBlocks.struct_launcher_core, 1), "SCS", "SIS", "BEB", 'S', ModBlocks.steel_scaffold, 'I', Blocks.IRON_BARS, 'C', ModItems.circuit_targeting_tier3, 'B', ModBlocks.struct_launcher, 'E', ModBlocks.machine_battery);
		addShapedRecipe(new ItemStack(ModBlocks.struct_launcher_core_large, 1), "SIS", "ICI", "BEB", 'S', ModItems.circuit_red_copper, 'I', Blocks.IRON_BARS, 'C', ModItems.circuit_targeting_tier4, 'B', ModBlocks.struct_launcher, 'E', ModBlocks.machine_battery);
		...
		addShapedRecipe(new ItemStack(ModBlocks.fence_metal, 6), "BIB", "BIB", 'B', Blocks.IRON_BARS, 'I', Items.IRON_INGOT);

		addShapelessRecipe(new ItemStack(ModBlocks.waste_trinitite), new ItemStack(Blocks.SAND, 1, 0), ModItems.trinitite);
		addShapelessRecipe(new ItemStack(ModBlocks.waste_trinitite_red), new ItemStack(Blocks.SAND, 1, 1), ModItems.trinitite);
		...
		addShapedRecipe(new ItemStack(ModItems.rune_blank, 1), "PSP", "SDS", "PSP", 'P', ModItems.powder_magic, 'S', ModItems.ingot_starmetal, 'D', KEY_CIRCUIT_BISMUTH);
		...
		addShapedRecipe(new ItemStack(ModItems.ams_lens, 1), "PDP", "GDG", "PDP", 'P', ModItems.plate_dineutronium, 'G', ModBlocks.reinforced_glass, 'D', Blocks.DIAMOND_BLOCK);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.barrel_iron, 1), "IPI", "I I", "IPI", 'I', IRON.plate(), 'P', "ingotIron");
		...
		addShapedRecipe(new ItemStack(ModItems.bottle_mercury, 1), "###", "#B#", "###", '#', ModItems.nugget_mercury, 'B', Items.GLASS_BOTTLE);
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_4gauge_explosive, 4), " I ", "GCL", " P ", 'I', Blocks.TNT, 'G', ModItems.cordite, 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		addShapedRecipe(new ItemStack(ModItems.ammo_4gauge_explosive, 4), " I ", "GCL", " P ", 'I', Blocks.TNT, 'G', ModItems.ballistite, 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		...
		addShapedRecipe(new ItemStack(Items.GOLD_INGOT, 1), "###", "###", "###", '#', ModItems.wire_gold);
		...
		addShapedOreRecipe(new ItemStack(ModItems.gun_ks23, 1), "PPM", "SWL", 'P', "plateSteel", 'M', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'W', ModItems.wire_tungsten, 'L', "logWood");
		addShapelessRecipe(new ItemStack(ModItems.gun_sauer, 1), ModItems.ducttape, ModItems.gun_ks23, Blocks.LEVER, ModItems.gun_ks23);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.det_cord, 8), "TNT", "NGN", "TNT", 'T', "plateSteel", 'N', "dustSaltpeter", 'G', "gunpowder");
		...
		addShapedRecipe(new ItemStack(ModBlocks.det_nuke, 1), "PDP", "DCD", "PDP", 'P', ModItems.plate_desh, 'D', ModItems.man_explosive8, 'C', ModItems.man_core);
		addShapedOreRecipe(new ItemStack(ModBlocks.det_miner, 3), "FFF", "ITI", "ITI", 'F', Items.FLINT, 'I', IRON.plate(), 'T', Blocks.TNT);
		addShapedOreRecipe(new ItemStack(ModBlocks.det_miner, 12), "FFF", "ITI", "ITI", 'F', Items.FLINT, 'I', "plateSteel", 'T', ModItems.ingot_semtex);
		...
		addShapedRecipe(new ItemStack(ModItems.bj_helmet, 1), "SBS", " C ", " I ", 'S', Items.STRING, 'B', new ItemStack(Blocks.WOOL, 1, 15), 'C', ModItems.circuit_targeting_tier4, 'I', ModItems.ingot_starmetal);
	...
	public static void reg3(){
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_sturdy, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "plankWood");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_iron, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "ingotIron");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_gold, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "ingotGold");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_aluminium, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', AL.ingot());
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_copper, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_titanium, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "ingotTitanium");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_lead, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "ingotLead");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_cobalt, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "ingotCobalt");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_steel, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', "ingotSteel");
		addShapedOreRecipe(new ItemStack(ModBlocks.ladder_tungsten, 8), "LLL", "L#L", "LLL", 'L', Blocks.LADDER, '#', W.ingot());
		...
		addShapelessRecipe(new ItemStack(ModBlocks.deco_rbmk, 8), ModBlocks.rbmk_blank);
		addShapelessRecipe(new ItemStack(ModBlocks.deco_rbmk_smooth, 1), ModBlocks.deco_rbmk);
		...
		addShapedRecipe(new ItemStack(ModBlocks.deco_pipe_framed, 8), "PPP", "PCP", "PPP", 'P', ModBlocks.deco_pipe, 'C', Blocks.IRON_BARS);
		addShapedRecipe(new ItemStack(ModBlocks.deco_pipe_framed, 8), "PPP", "PCP", "PPP", 'P', ModBlocks.deco_pipe_rim, 'C', Blocks.IRON_BARS);
		...
		addShapedRecipe(new ItemStack(ModItems.fau_helmet, 1), "PWP", "PBP", "FSF", 'P', ModItems.plate_armor_fau, 'W', new ItemStack(Blocks.WOOL, 1, 14), 'B', ModItems.starmetal_helmet, 'F', ModItems.gas_mask_filter, 'S', ModItems.pipes_steel);
		...
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell, 4), " T ", "GHG", "CCC", 'T', Blocks.TNT, 'G', Items.GUNPOWDER, 'H', ModItems.hull_small_steel, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell, 4), " T ", "GHG", "CCC", 'T', Blocks.TNT, 'G', ModItems.ballistite, 'H', ModItems.hull_small_steel, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell, 6), " T ", "GHG", "CCC", 'T', Blocks.TNT, 'G', ModItems.cordite, 'H', ModItems.hull_small_steel, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_explosive, 4), " T ", "GHG", "CCC", 'T', ModItems.ingot_semtex, 'G', Items.GUNPOWDER, 'H', ModItems.hull_small_steel, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_explosive, 4), " T ", "GHG", "CCC", 'T', ModItems.ingot_semtex, 'G', ModItems.ballistite, 'H', ModItems.hull_small_steel, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_explosive, 6), " T ", "GHG", "CCC", 'T', ModItems.ingot_semtex, 'G', ModItems.cordite, 'H', ModItems.hull_small_steel, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_apfsds_t, 4), " I ", "GIG", "CCC", 'I', W.ingot(), 'G', Items.GUNPOWDER, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_apfsds_t, 4), " I ", "GIG", "CCC", 'I', W.ingot(), 'G', ModItems.ballistite, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_apfsds_t, 6), " I ", "GIG", "CCC", 'I', W.ingot(), 'G', ModItems.cordite, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_apfsds_du, 4), " I ", "GIG", "CCC", 'I', "ingotUranium238", 'G', Items.GUNPOWDER, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_apfsds_du, 4), " I ", "GIG", "CCC", 'I', "ingotUranium238", 'G', ModItems.ballistite, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_shell_apfsds_du, 6), " I ", "GIG", "CCC", 'I', "ingotUranium238", 'G', ModItems.cordite, 'C', CU.ingot());
		...
		addShapelessRecipe(new ItemStack(ModItems.ingot_smore), Items.WHEAT, new ItemStack(ModItems.marshmallow, 1, 1), new ItemStack(Items.DYE, 1, 3));
		addShapelessRecipe(new ItemStack(ModItems.marshmallow), Items.STICK, Items.SUGAR, Items.WHEAT_SEEDS);

		addShapedRecipe(new ItemStack(ModItems.coltass, 1), "ACA", "CXC", "ACA", 'A', ModItems.ingot_advanced_alloy, 'C', ModItems.cinnebar, 'X', Items.COMPASS);
		...
		addShapedOreRecipe(new ItemStack(ModItems.reacher, 1), "BIB", "P P", "B B", 'B', ModItems.bolt_tungsten, 'I', W.ingot(), 'P', ModItems.plate_polymer);
		...
		addShapedOreRecipe(new ItemStack(ModItems.circuit_bismuth_raw, 1), "RPR", "ABA", "RPR", 'R', "dustRedstone", 'P', "ingotPolymer", 'A', (GeneralConfig.enable528 ? ModItems.circuit_tantalium : "ingotAsbestos"), 'B', ModItems.ingot_bismuth);

		addShapedRecipe(new ItemStack(ModItems.inf_water_mk2, 1), "BPB", "PTP", "BPB", 'B', ModItems.inf_water, 'P', ModBlocks.fluid_duct_mk2, 'T', ModItems.tank_steel);

		addShapedOreRecipe(new ItemStack(ModBlocks.machine_condenser), "SIS", "ICI", "SIS", 'S', "ingotSteel", 'I', IRON.plate(), 'C', ModItems.board_copper);
		...
		addShapedRecipe(new ItemStack(ModItems.battery_sc_lead), "NBN", "PCP", "NBN", 'N', ModItems.nugget_tantalium, 'B', ModItems.billet_pb209, 'P', ModItems.ingot_polymer, 'C', ModItems.battery_sc_gold);
		addShapedRecipe(new ItemStack(ModItems.battery_sc_americium), "NBN", "PCP", "NBN", 'N', ModItems.nugget_tantalium, 'B', ModItems.billet_am241, 'P', ModItems.ingot_polymer, 'C', ModItems.battery_sc_lead);
		addShapedRecipe(new ItemStack(ModItems.battery_sc_balefire), "NBN", "PCP", "NBN", 'N', ModItems.nugget_radspice, 'B', ModItems.pellet_rtg_balefire, 'P', ModItems.ingot_polymer, 'C', ModItems.battery_sc_americium);
		...
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_grate), 4), "SS", "SS", 'S', ModBlocks.steel_beam);

		addShapedOreRecipe(new ItemStack(ModItems.pile_rod_uranium, 1), " U ", "PUP", " U ", 'P', IRON.plate(), 'U', ModItems.billet_uranium);
		addShapedOreRecipe(new ItemStack(ModItems.pile_rod_source, 1), " U ", "PUP", " U ", 'P', IRON.plate(), 'U', ModItems.billet_ra226be);
		...
		addShapedRecipe(new ItemStack(ModBlocks.rbmk_outgasser, 1), "GHG", "GRG", "GTG", 'G', ModBlocks.steel_grate, 'H', Blocks.HOPPER, 'T', ModItems.tank_steel, 'R', ModBlocks.rbmk_blank);
		addShapedRecipe(new ItemStack(ModBlocks.rbmk_storage, 1), "C", "R", "C", 'C', ModBlocks.crate_steel, 'R', ModBlocks.rbmk_blank);
		addShapedOreRecipe(new ItemStack(ModBlocks.rbmk_loader, 1), "SCS", "CBC", "SCS", 'S', "plateSteel", 'C', CU.ingot(), 'B', ModItems.tank_steel);
		addShapedOreRecipe(new ItemStack(ModBlocks.rbmk_steam_inlet, 1), "SCS", "CBC", "SCS", 'S', "ingotSteel", 'C', IRON.plate(), 'B', ModItems.tank_steel);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.machine_fraction_tower), "SHS", "SGS", "SHS", 'S', "plateSteel", 'H', ModItems.hull_big_steel, 'G', ModItems.ingot_lanthanium);
		addShapedRecipe(new ItemStack(ModBlocks.fraction_spacer), "BHB", 'H', ModItems.hull_big_steel, 'B', Blocks.IRON_BARS);

		//Cladding
		addShapelessOreRecipe(new ItemStack(ModItems.cladding_paint, 1), "nuggetLead", "nuggetLead", "nuggetLead", "nuggetLead", Items.CLAY_BALL, Items.GLASS_BOTTLE);
		...
		addShapedRecipe(new ItemStack(ModItems.cladding_paa, 1), "DPD", "PRP", "DPD", 'R', ModItems.cladding_desh, 'P', ModItems.plate_paa, 'D', ModItems.ducttape);
		addShapedRecipe(new ItemStack(ModItems.cladding_ghiorsium, 1), "DPD", "PRP", "DPD", 'R', ModItems.cladding_paa, 'P', ModItems.ingot_gh336, 'D', ModItems.ducttape);
		addShapedRecipe(new ItemStack(ModItems.cladding_di, 1), "DPD", "PRP", "DPD", 'R', ModItems.cladding_ghiorsium, 'P', ModItems.plate_dineutronium, 'D', ModItems.ducttape);
		addShapedRecipe(new ItemStack(ModItems.cladding_electronium, 1), "DPD", "PRP", "DPD", 'R', ModItems.cladding_di, 'P', ModItems.ingot_electronium, 'D', ModItems.ducttape);
		addShapedOreRecipe(new ItemStack(ModItems.cladding_obsidian, 1), "OOO", "PDP", "OOO", 'O', Blocks.OBSIDIAN, 'P', "plateSteel", 'D', ModItems.ducttape);
		addShapedOreRecipe(new ItemStack(ModItems.cladding_iron, 1), "OOO", "PDP", "OOO", 'O', IRON.plate(), 'P', ModItems.plate_polymer, 'D', ModItems.ducttape);

		//Inserts
		addShapedOreRecipe(new ItemStack(ModItems.insert_steel, 1), "DPD", "PSP", "DPD", 'D', ModItems.ducttape, 'P', IRON.plate(), 'S', "blockSteel");
		addShapedOreRecipe(new ItemStack(ModItems.insert_du, 1), "DPD", "PSP", "DPD", 'D', ModItems.ducttape, 'P', IRON.plate(), 'S', "blockUranium238");
		addShapedOreRecipe(new ItemStack(ModItems.insert_polonium, 1), "DPD", "PSP", "DPD", 'D', ModItems.ducttape, 'P', IRON.plate(), 'S', "blockPolonium");
		addShapedOreRecipe(new ItemStack(ModItems.insert_era, 1), "DPD", "PSP", "DPD", 'D', ModItems.ducttape, 'P', IRON.plate(), 'S', ModItems.ingot_semtex);
		...
		addShapedRecipe(new ItemStack(ModItems.insert_ghiorsium, 1), "PKP", "KSK", "PKP", 'P', ModItems.ducttape, 'K', ModItems.ingot_gh336, 'S', ModItems.ingot_u238);
		addShapedRecipe(new ItemStack(ModItems.insert_di, 1), "PKP", "KSK", "PKP", 'P', ModItems.ducttape, 'K', ModItems.plate_dineutronium, 'S', ModItems.insert_ghiorsium);
		addShapedRecipe(new ItemStack(ModItems.insert_yharonite, 1), "YIY", "IYI", "YIY", 'Y', ModItems.billet_yharonite, 'I', ModItems.insert_du);

		//Servos
		addShapedOreRecipe(new ItemStack(ModItems.servo_set, 1), "MBM", "PBP", "MBM", 'M', ModItems.motor, 'B', ModItems.bolt_tungsten, 'P', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.servo_set_desh, 1), "MBM", "PSP", "MBM", 'M', ModItems.motor_desh, 'B', ModItems.bolt_dura_steel, 'P', ALLOY.plate(), 'S', ModItems.servo_set);

		//Helmet Mods
		addShapedOreRecipe(new ItemStack(ModItems.attachment_mask, 1), "DID", "IGI", " F ", 'D', ModItems.ducttape, 'I', ModItems.plate_polymer, 'G', "paneGlass", 'F', IRON.plate());
		addShapedOreRecipe(new ItemStack(ModItems.attachment_mask_mono, 1), " D ", "DID", " F ", 'D', ModItems.ducttape, 'I', ModItems.plate_polymer, 'F', IRON.plate());

		//Boot Mods
		addShapedOreRecipe(new ItemStack(ModItems.pads_rubber, 1), "P P", "IDI", "P P", 'P', ModItems.plate_polymer, 'I', IRON.plate(), 'D', ModItems.ducttape);
		...
		addShapedOreRecipe(new ItemStack(ModItems.heart_container, 1), "HAH", "ACA", "HAH", 'H', ModItems.heart_piece, 'A', AL.ingot(), 'C', ModItems.coin_creeper);
		...
		addShapedOreRecipe(new ItemStack(ModItems.ink, 1), "FPF", "PIP", "FPF", 'F', new ItemStack(Blocks.RED_FLOWER, 1, OreDictionary.WILDCARD_VALUE), 'P', ModItems.armor_polish, 'I', "dyeBlack");
		...
		addShapedRecipe(new ItemStack(ModItems.bathwater_mk3, 1), "MWM", "WBW", "MWM", 'M', ModBlocks.block_corium_cobble, 'W', ModItems.powder_radspice, 'B', ModItems.bathwater_mk2);
		...
		addShapedRecipe(new ItemStack(ModItems.medal_ghoul, 1), "GEG", "BFB", "GEG", 'G', ModItems.nugget_u238m2, 'B', ModBlocks.pribris_digamma, 'E', ModItems.glitch, 'F', ModItems.medal_liquidator);
		...
		addShapelessRecipe(new ItemStack(ModItems.injector_knife, 1), ModItems.injector_5htp, Items.IRON_SWORD);
		...
		addShapelessOreRecipe(new ItemStack(ModItems.cladding_paint, 1), "dustLead", Items.CLAY_BALL, Items.GLASS_BOTTLE);
		addShapedOreRecipe(new ItemStack(ModItems.cladding_rubber, 1), "RCR", "CDC", "RCR", 'R', ModItems.plate_polymer, 'C', "dustCoal", 'D', ModItems.ducttape);
		addShapedOreRecipe(new ItemStack(ModItems.cladding_lead, 1), "DPD", "PRP", "DPD", 'R', ModItems.cladding_rubber, 'P', "plateLead", 'D', ModItems.ducttape);
		addShapedRecipe(new ItemStack(ModItems.cladding_desh, 1), "DPD", "PRP", "DPD", 'R', ModItems.cladding_lead, 'P', ModItems.plate_desh, 'D', ModItems.ducttape);
		...
		addShapedOreRecipe(new ItemStack(ModItems.drax, 1), "BDS", "CDC", "FMF", 'B', ModItems.starmetal_pickaxe, 'S', ModItems.starmetal_shovel, 'C', "ingotCobalt", 'F', ModItems.fusion_core, 'D', DESH.ingot(), 'M', ModItems.motor_desh);
		...
		addShapedOreRecipe(new ItemStack(ModItems.upgrade_smelter, 1), "PHP", "CUC", "DTD", 'P', "plateCopper", 'H', Blocks.HOPPER, 'C', ModItems.coil_tungsten, 'U', ModItems.upgrade_template, 'D', ModItems.coil_copper, 'T', ModBlocks.machine_transformer);
		addShapedOreRecipe(new ItemStack(ModItems.upgrade_shredder, 1), "PHP", "CUC", "DTD", 'P', ModItems.motor, 'H', Blocks.HOPPER, 'C', ModItems.blades_advanced_alloy, 'U', ModItems.upgrade_smelter, 'D', "plateTitanium", 'T', ModBlocks.machine_transformer);
		addShapedOreRecipe(new ItemStack(ModItems.upgrade_centrifuge, 1), "PHP", "PUP", "DTD", 'P', ModItems.centrifuge_element, 'H', Blocks.HOPPER, 'U', ModItems.upgrade_shredder, 'D', "ingotPolymer", 'T', ModBlocks.machine_transformer);
		...
		addShapedOreRecipe(new ItemStack(ModItems.particle_empty, 2), "STS", "G G", "STS", 'S', "plateSteel", 'T', W.ingot(), 'G', "paneGlass");
		...
		addShapedRecipe(infinity, "SBS", "BDB", "SBS", 'S', ModItems.ammo_50bmg_star, 'B', ModItems.ammo_5mm_star, 'D', ModItems.powder_magic);
		...
		addShapedRecipe(unbreaking, "SBS", "BDB", "SBS", 'S', ModItems.ingot_saturnite, 'B', ModItems.plate_armor_lunar, 'D', ModItems.powder_magic);
		ItemStack thorns = new ItemStack(Items.ENCHANTED_BOOK);
		EnchantmentUtil.addEnchantment(thorns, Enchantments.THORNS, 3);
		addShapedRecipe(thorns, "SBS", "BDB", "SBS", 'S', ModBlocks.barbed_wire, 'B', ModBlocks.spikes, 'D', ModItems.powder_magic);
		...
		addShapedRecipe(new ItemStack(ModBlocks.hadron_coil_schrabidate, 1), " S ", "SCS", " S ", 'S', ModItems.powder_schrabidate, 'C', ModBlocks.hadron_coil_schrabidium);
		addShapedRecipe(new ItemStack(ModBlocks.hadron_coil_schrabidium, 1), "SCS", "CSC", "SCS", 'S', ModItems.wire_schrabidium, 'C', ModBlocks.hadron_coil_alloy);
		addShapedRecipe(new ItemStack(ModBlocks.hadron_coil_starmetal, 1), "ICI", "ISI", "ICI", 'S', ModBlocks.hadron_coil_schrabidate, 'C', ModBlocks.hadron_coil_neodymium,'I',STAR.ingot());
		...
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.steel_beam), 8), "S", "S", "S", 'S', ModBlocks.steel_scaffold);
		addShapedOreRecipe(new ItemStack(ModItems.mirror_tool), " A ", " IA", "I  ", 'A', AL.ingot(), 'I', "ingotIron");
		addShapedOreRecipe(new ItemStack(ModItems.rbmk_tool), " A ", " IA", "I  ", 'A', "ingotLead", 'I', "ingotIron");
		addShapedOreRecipe(new ItemStack(ModItems.hand_drill), " D", "S ", " S", 'D', DURA.ingot(), 'S', Items.STICK);
		...
		addShapedRecipe(new ItemStack(ModBlocks.machine_detector, 1), "IRI", "CTC", "IRI", 'I', ModItems.plate_polymer, 'R', Items.REDSTONE, 'C', ModItems.wire_red_copper, 'T', ModItems.coil_tungsten);
		addShapedOreRecipe(new ItemStack(ModItems.ingot_schrabidium, 8), "UUU", "UPU", "UUU", 'U', "ingotUranium", 'P', new ItemStack(ModItems.particle_higgs).setStackDisplayName("Higgs Boson (Temporary Recipe)"));
		addShapedOreRecipe(new ItemStack(ModItems.ingot_euphemium, 8), "UUU", "UPU", "UUU", 'U', "ingotPlutonium", 'P', new ItemStack(ModItems.particle_dark).setStackDisplayName("Dark Matter (Temporary Recipe)"));
		addShapedRecipe(new ItemStack(ModItems.ingot_dineutronium, 8), "UUU", "UPU", "UUU", 'U', ModItems.ingot_schrabidate, 'P', new ItemStack(ModItems.particle_sparkticle).setStackDisplayName("Sparkticle (Temporary Recipe)"));
		addShapedOreRecipe(new ItemStack(ModItems.meteorite_sword, 1), "  B", "GB ", "SG ", 'B', ModItems.blade_meteorite, 'G', "plateGold", 'S', Items.STICK);
		...
		addShapedOreRecipe(new ItemStack(ModBlocks.fireworks, 1), "PPP", "PPP", "WIW", 'P', Items.PAPER, 'W', "plankWood", 'I', "ingotIron");
		...
		addShapedRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.chain), 8), "S", "S", "S", 'S', ModBlocks.steel_beam);

		addShapedOreRecipe(new ItemStack(ModBlocks.spinny_light), " G ", "GFG", "SRS", 'G', "blockGlass", 'F', ModItems.fuse, 'S', new ItemStack(Blocks.STONE_SLAB, 1, 0), 'R', "dustRedstone");
		...
		addShapedOreRecipe(new ItemStack(ModItems.sliding_blast_door_skin0), "SPS", "DPD", "SPS", 'P', Items.PAPER, 'D', "dye", 'S', "plateSteel");
		...
		//Peas
		addShapedRecipe(new ItemStack(ModItems.peas), " S ", "SNS", " S ", 'S', Items.WHEAT_SEEDS, 'N', Items.GOLD_NUGGET);
		...
		addShapedOreRecipe(new ItemStack(ModItems.jshotgun, 1), "LPP", "SSW", "PPD", 'S', ModItems.gun_uboinik, 'P', "plateSteel", 'D', new ItemStack(Items.DYE, 1, EnumDyeColor.GREEN.getDyeDamage()), 'L', ModBlocks.spinny_light, 'W', ModItems.mechanism_rifle_2);

		addShapedOreRecipe(new ItemStack(ModBlocks.machine_armor_table, 1), "PPP", "TCT", "TST", 'P', "plateSteel", 'T', W.ingot(), 'C', Blocks.CRAFTING_TABLE, 'S', "blockSteel");
		...
		addShapelessRecipe(new ItemStack(ModItems.billet_flashlead, 1), ModItems.billet_au198, ModItems.billet_pb209, new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.amat)), ModItems.pellet_charged);

		addShapedOreRecipe(new ItemStack(ModItems.ammo_dgk, 1), "LLL", "GGG", "CCC", 'L', "plateLead", 'G', ModItems.ballistite, 'C', CU.ingot());
		addShapedOreRecipe(new ItemStack(ModItems.ammo_dgk, 1), "LLL", "GGG", "CCC", 'L', "plateLead", 'G', ModItems.cordite, 'C', CU.ingot());
		...
		addShapedRecipe(new ItemStack(ModItems.ammo_nuke_safe, 1), "G", "N", 'G', Items.GLOWSTONE_DUST, 'N', ModItems.ammo_nuke_low);
		addShapedRecipe(new ItemStack(ModItems.ammo_nuke_pumpkin, 1), " T ", "TST", " T ", 'T', Blocks.TNT, 'S', ModItems.assembly_nuke);
		...
		if(!GeneralConfig.enable528) {
			...
			addShapedOreRecipe(new ItemStack(ModBlocks.rbmk_console, 1), "BBB", "DGD", "DCD", 'B', ModItems.ingot_boron, 'D', ModBlocks.deco_rbmk, 'G', "paneGlass", 'C', ModItems.circuit_targeting_tier3);
			addShapedRecipe(new ItemStack(ModBlocks.rbmk_crane_console, 1), "BCN", "DDD", 'B', ModItems.ingot_boron, 'D', ModBlocks.deco_rbmk, 'C', ModItems.circuit_targeting_tier3, 'N', ModItems.gun_fatman_ammo);
		...
		if(GeneralConfig.enableBabyMode) {
			addShapelessRecipe(new ItemStack(ModItems.cordite, 3), ModItems.ballistite, Items.GUNPOWDER, new ItemStack(Blocks.WOOL, 1, OreDictionary.WILDCARD_VALUE));
			addShapelessRecipe(new ItemStack(ModItems.ingot_semtex, 3), Items.SLIME_BALL, Blocks.TNT, ModItems.niter);
			addShapelessRecipe(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.oil)), Items.REDSTONE);

			addShapelessRecipe(new ItemStack(ModBlocks.ore_uranium, 1), ModBlocks.ore_uranium_scorched, Items.WATER_BUCKET);
			addShapedRecipe(new ItemStack(ModBlocks.ore_uranium, 8), "OOO", "OBO", "OOO", 'O', ModBlocks.ore_uranium_scorched, 'B', Items.WATER_BUCKET);
			addShapelessRecipe(new ItemStack(ModBlocks.ore_nether_uranium, 1), ModBlocks.ore_nether_uranium_scorched, Items.WATER_BUCKET);
			addShapedRecipe(new ItemStack(ModBlocks.ore_nether_uranium, 8), "OOO", "OBO", "OOO", 'O', ModBlocks.ore_nether_uranium_scorched, 'B', Items.WATER_BUCKET);
			addShapelessRecipe(new ItemStack(ModBlocks.ore_gneiss_uranium, 1), ModBlocks.ore_gneiss_uranium_scorched, Items.WATER_BUCKET);
			addShapedRecipe(new ItemStack(ModBlocks.ore_gneiss_uranium, 8), "OOO", "OBO", "OOO", 'O', ModBlocks.ore_gneiss_uranium_scorched, 'B', Items.WATER_BUCKET);
			...
			addShapedOreRecipe(new ItemStack(ModItems.plate_aluminium, 4), "##", "##", '#', AL.ingot());
			addShapedOreRecipe(new ItemStack(ModItems.plate_titanium, 4), "##", "##", '#', "ingotTitanium");
			addShapedOreRecipe(new ItemStack(ModItems.plate_copper, 4), "##", "##", '#', CU.ingot());
			...
			addShapedOreRecipe(new ItemStack(ModItems.neutron_reflector, 4), "##", "##", '#', W.ingot());

			addShapedOreRecipe(new ItemStack(ModItems.wire_aluminium, 16), "###", '#', AL.ingot());
			addShapedOreRecipe(new ItemStack(ModItems.wire_copper, 16), "###", '#', CU.ingot());
			addShapedOreRecipe(new ItemStack(ModItems.wire_tungsten, 16), "###", '#', W.ingot());
			...
			addShapedOreRecipe(new ItemStack(ModItems.book_of_), "BGB", "GAG", "BGB", 'B', ModItems.egg_balefire_shard, 'G', "ingotGold", 'A', Items.BOOK);
		}
	}
	...
	public static void addSlabStair(Block slab, Block stair, Block block){
		addShapedRecipe(new ItemStack(slab, 6), "###", '#', block);
		addShapedRecipe(new ItemStack(stair, 8), "#  ","## ","###", '#', block);
		addShapedRecipe(new ItemStack(stair, 4), "#  ","## ","###", '#', slab);
		addShapelessRecipe(new ItemStack(block, 3), stair, stair, stair, stair);
		addShapelessRecipe(new ItemStack(block), slab, slab);
	}

	public static void addBillet(Item billet, Item nugget, String... ore){
		for(String o : ore)
			addShapedOreRecipe(new ItemStack(billet), "###", "###", '#', o);

		addBillet(billet, nugget);
	}

	public static void addBillet(Item billet, Item nugget){
		addShapedRecipe(new ItemStack(billet), "###", "###", '#', nugget);
		addShapelessRecipe(new ItemStack(nugget, 6), billet);
	}

	public static void addBilletByIngot(Item billet, Item ingot, String... ore){
		for(String o : ore)
			addShapelessOreRecipe(new ItemStack(billet, 3), o, o);
		addShapelessRecipe(new ItemStack(billet, 3), ingot, ingot);
		addShapelessRecipe(new ItemStack(ingot, 2), billet, billet, billet);
	}
	...
	public static void add9To1(ItemStack nine, ItemStack one){
		addShapedRecipe(one, "###", "###", "###", '#', nine);
	}

	//Fill rods with 6 nuggets
	public static void addRod(Item nugget, Item out){
		addShapelessRecipe(new ItemStack(out), ModItems.rod_empty, nugget, nugget, nugget, nugget, nugget, nugget);
	}

	//Fill rods with 12 nuggets
	public static void addDualRod(Item ingot, Item nugget, Item out){
		addShapelessRecipe(new ItemStack(out), ModItems.rod_dual_empty, ingot, nugget, nugget, nugget);
	}

	//Fill rods with 24 nuggets
	public static void addQuadRod(Item ingot, Item nugget, Item out){
		addShapelessRecipe(new ItemStack(out), ModItems.rod_quad_empty, ingot, ingot, nugget, nugget, nugget, nugget, nugget, nugget);
	}

	public static void addSword(Item ingot, Item sword){
		addShapedRecipe(new ItemStack(sword), "I", "I", "S", 'I', ingot, 'S', Items.STICK);
	}

	public static void addPickaxe(Item ingot, Item pick){
		addShapedRecipe(new ItemStack(pick), "III", " S ", " S ", 'I', ingot, 'S', Items.STICK);
	}

	public static void addAxe(Item ingot, Item axe){
		addShapedRecipe(new ItemStack(axe), "II", "IS", " S", 'I', ingot, 'S', Items.STICK);
	}

	public static void addShovel(Item ingot, Item shovel){
		addShapedRecipe(new ItemStack(shovel), "I", "S", "S", 'I', ingot, 'S', Items.STICK);
	}

	public static void addHoe(Item ingot, Item hoe){
		addShapedRecipe(new ItemStack(hoe), "II", " S", " S", 'I', ingot, 'S', Items.STICK);
	}
