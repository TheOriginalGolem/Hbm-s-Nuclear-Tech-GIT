...
public class ItemRBMKPellet extends Item implements IItemHazard {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        switch (meta % 5) {
            case 0:
                tooltip.add(TextFormatting.GOLD + "Brand New");
                break;
            case 1:
                tooltip.add(TextFormatting.YELLOW + "Barely Depleted");
                break;
            case 2:
                tooltip.add(TextFormatting.GREEN + "Moderately Depleted");
                break;
            case 3:
                tooltip.add(TextFormatting.DARK_GREEN + "Highly Depleted");
                break;
            case 4:
                tooltip.add(TextFormatting.DARK_GRAY + "Fully Depleted");
                break;
        }
