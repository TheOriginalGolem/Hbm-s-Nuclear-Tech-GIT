    ...
    public static class RecursionAbility extends ToolAbility {
        ...
        public void onDig(World world, int x, int y, int z, EntityPlayer player, IBlockState block, IItemAbility tool, EnumHand hand) {
            ...
            for (Integer i : indices) {
                switch (i) {
                    case 0:
                        breakExtra(world, x + 1, y, z, x, y, z, player, tool, hand, 0);
                        break;
                    case 1:
                        breakExtra(world, x - 1, y, z, x, y, z, player, tool, hand, 0);
                        break;
                    case 2:
                        breakExtra(world, x, y + 1, z, x, y, z, player, tool, hand, 0);
                        break;
                    case 3:
                        breakExtra(world, x, y - 1, z, x, y, z, player, tool, hand, 0);
                        break;
                    case 4:
                        breakExtra(world, x, y, z + 1, x, y, z, player, tool, hand, 0);
                        break;
                    case 5:
                        breakExtra(world, x, y, z - 1, x, y, z, player, tool, hand, 0);
                        break;
        ...
        private void breakExtra(World world, int x, int y, int z, int refX, int refY, int refZ, EntityPlayer player, IItemAbility tool, EnumHand hand, int depth) {
            ...
            for (Integer i : indices) {
                switch (i) {
                    case 0:
                        breakExtra(world, x + 1, y, z, refX, refY, refZ, player, tool, hand, depth);
                        break;
                    case 1:
                        breakExtra(world, x - 1, y, z, refX, refY, refZ, player, tool, hand, depth);
                        break;
                    case 2:
                        breakExtra(world, x, y + 1, z, refX, refY, refZ, player, tool, hand, depth);
                        break;
                    case 3:
                        breakExtra(world, x, y - 1, z, refX, refY, refZ, player, tool, hand, depth);
                        break;
                    case 4:
                        breakExtra(world, x, y, z + 1, refX, refY, refZ, player, tool, hand, depth);
                        break;
                    case 5:
                        breakExtra(world, x, y, z - 1, refX, refY, refZ, player, tool, hand, depth);
                        break;
