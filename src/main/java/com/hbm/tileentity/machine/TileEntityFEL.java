                    ...
                    for (EntityLivingBase entity : list) {
                        switch (this.mode) {
                            ...
                            case IR:
                                ...
                                break;
                            case VISIBLE:
                                entity.addPotionEffect(new PotionEffect(Potion.getPotionById(15), 60 * 60 * 65536, 0));
                            case UV:
                                entity.setFire(10);
                                ContaminationUtil.contaminate(entity, HazardType.RADIATION, ContaminationType.CREATIVE, 0.025F);
                                break;
                            case XRAY:
                                ContaminationUtil.contaminate(entity, HazardType.RADIATION, ContaminationType.CREATIVE, 1F);
                                break;
                            case GAMMA:
