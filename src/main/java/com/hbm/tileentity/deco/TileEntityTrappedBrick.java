        ...
        switch (trap) {
            ...
            case ZOMBIE:
                ...
                switch (world.rand.nextInt(3)) {
                    case 0:
                        zombie.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ModItems.chernobylsign));
                        break;
                    case 1:
                        zombie.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ModItems.cobalt_sword));
                        break;
                    case 2:
                        zombie.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ModItems.cmb_hoe));
                        break;
                }
