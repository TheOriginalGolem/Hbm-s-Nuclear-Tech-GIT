...
public class TileEntityNukeMan extends TileEntity {
    ...
    public boolean exp1() {
        return this.inventory.getStackInSlot(1) != ItemStack.EMPTY && this.inventory.getStackInSlot(1).getItem() == ModItems.man_explosive8;
    }

    public boolean exp2() {
        return this.inventory.getStackInSlot(2) != ItemStack.EMPTY && this.inventory.getStackInSlot(2).getItem() == ModItems.man_explosive8;
    }

    public boolean exp3() {
        return this.inventory.getStackInSlot(3) != ItemStack.EMPTY && this.inventory.getStackInSlot(3).getItem() == ModItems.man_explosive8;
    }

    public boolean exp4() {
        return this.inventory.getStackInSlot(4) != ItemStack.EMPTY && this.inventory.getStackInSlot(4).getItem() == ModItems.man_explosive8;
    }
