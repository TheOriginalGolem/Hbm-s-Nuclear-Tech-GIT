...
public class RenderBulletMk2 extends Render<EntityBulletBase> {
    ...
    private void renderDart(int style, int eID) {
        ...
        float blue = 1F;
        switch (style) {
            case BulletConfiguration.BOLT_LASER:
                red = 1F;
                green = 0F;
                blue = 0F;
                break;
            case BulletConfiguration.BOLT_NIGHTMARE:
                red = 1F;
                green = 1F;
                blue = 0F;
                break;
            case BulletConfiguration.BOLT_LACUNAE:
                red = 0.25F;
                green = 0F;
                blue = 0.75F;
                break;
            case BulletConfiguration.BOLT_WORM:
                red = 0F;
                green = 1F;
                blue = 0F;
                break;
    ...
    private void renderMeteor(int type) {
        ...
        switch (type) {
            case 0:
                bindTexture(new ResourceLocation(RefStrings.MODID + ":textures/blocks/block_meteor_molten.png"));
                break;
            case 1:
