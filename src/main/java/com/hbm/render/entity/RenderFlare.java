...
public class RenderFlare<E extends Entity> extends Render<E> {
    ...
    public static final IRenderFactory<EntityGrenadeFlare> FACTORY = (RenderManager man) -> {
        return new RenderFlare<EntityGrenadeFlare>(man);
    };
    public static final IRenderFactory<EntitySchrab> FACTORY_SCHRAB = (RenderManager man) -> {
        return new RenderFlare<EntitySchrab>(man);
    };
